...
getTL:function(key,zoom){return new L.tileLayer.sentinel("http://services.eocloud.sentinel-hub.com/v1/wms/{s}",{zoomdomains:["814e7a7a-d0b4-4355-a327-2e490cf268a2"],subdomains:["ff6d8302-2479-4a5a-9406-255d87cab12f","b4144647-aedd-421f-8bfa-e93803bed520","3edfd6dc-9de1-4e93-ae14-f49d8e73b0af","de23c422-a74b-49ef-952f-335714aca15a"],transpic:"/images/explorer/trans.512.png",layers:"1_TRUE_COLOR",format:"image/png",transparent:true,version:"1.3.1",attribution:'<a href="https://www.sentinel-hub.com/">Sentinel-Hub</a>',
...
{buildDate:function(day){return"&TIME="+utc(day).delta("days",-3).toIso()+"/"+day},zoomdomains:["814e7a7a-d0b4-4355-a327-2e490cf268a2"],subdomains:["814e7a7a-d0b4-4355-a327-2e490cf268a2"],transpic:"/images/explorer/trans.512.png",layers:"1_TRUE_COLOR",format:"image/png",transparent:true,version:"1.3.1",attribution:'<a href="https://www.sentinel-hub.com/">Sentinel-Hub</a>',srs:"EPSG:3995",tileSize:512,noWrap:true,continuousWorld:false,minZoom:zoom.min,maxZoom:zoom.max-zoom.min})}}},{"gfs-simulation":{enabled:DEBUG,
index:21,type:"sim-overlay",order:310,name:"Weather Simulation",icon:"/images/explorer/maps/gfs-simulation.png",comment:"Surface conditions (2m temp, 10m wind)",epsg:"3413",bounds:[[38.8,180],[38.8,0]],opacity:0.6,urlPattern:IMAGEOVERLAYROOT+"gfs/%Y/gfs-%Y-%m-%d-%H.png",timeRange:timeRanges["gfs-simulation"],attribution:"<a href='http://nomads.ncep.noaa.gov/txt_descriptions/GFS_high_resolution_doc.shtml'>NCEP/GFS</a>",colorbar:"/images/explorer/cbar-gfs.png"}},{"gfs-forecast":{enabled:true,index:16,
type:"image-overlay",order:400,name:"GFS Forecast",icon:"/images/explorer/maps/gfs-temps-icon.png",comment:"Surface conditions (2m temp, 10m wind (>10m/s), SLP)",epsg:"3413",bounds:[[38.8,180],[38.8,0]],opacity:0.6,urlPattern:IMAGEOVERLAYROOT+"gfs/%Y/gfs-%Y-%m-%d-%H.png",timeRange:timeRanges["gfs-forecast"],attribution:"<a href='http://nomads.ncep.noaa.gov/txt_descriptions/GFS_high_resolution_doc.shtml'>NCEP/GFS</a>",colorbar:"/images/explorer/cbar-gfs.png"}},{"sst-avhrr":{enabled:true,index:22,type:"image-overlay",
order:410,name:"Sea Surface Temp.",icon:"/images/explorer/maps/sit-smos-icon.png",comment:"Daily Sea Surface Temperature (AVHRR)",epsg:"3413",bounds:[[38.8,180],[38.8,0]],opacity:0.9,urlPattern:IMAGEOVERLAYROOT+"sst/%Y/sst-%Y-%m-%d.png",timeRange:timeRanges["sst-avhrr"],attribution:"",colorbar:""}},{"sic-amsr2":{enabled:true,index:17,type:"image-overlay",order:420,name:"Sea Ice Concentration",icon:"/images/explorer/maps/sic-amsr2-icon.png",comment:"Daily high resolution maps from the AMSR2 instrument",
epsg:"3413",bounds:[[38.8,180],[38.8,0]],opacity:0.9,urlPattern:IMAGEOVERLAYROOT+"amsr2/%Y/amsr2-%Y-%m-%d.png",timeRange:timeRanges["sic-amsr2"],attribution:'<a href="ftp://ftp-projects.zmaw.de/seaice/AMSR2/README.txt">University of Hamburg</a>'}},{"sit-cryosat":{enabled:true,index:18,type:"image-overlay",order:430,name:"CryoSat Thickness",icon:"/images/explorer/maps/sit-smos-icon.png",comment:"Monthly (winter) thickness from the ESA's CryoSat 2 satellite",epsg:"3413",bounds:[[38.8,180],[38.8,0]],
opacity:0.9,urlPattern:IMAGEOVERLAYROOT+"cryosat/%Y/cryosat-%Y-%m.png",timeRange:timeRanges["sit-cryosat"],attribution:'<a href="http://www.awi.de/en/home/">AWI</a>',colorbar:"/images/explorer/cbar-cryo.png"}},{"sit-smos":{enabled:true,index:19,type:"image-overlay",order:440,name:"SMOS Thickness",icon:"/images/explorer/maps/sit-smos-icon.png",comment:"Daily (winter) sea ice thickness (m) from the ESA's SMOS satellite",epsg:"3413",bounds:[[38.8,180],[38.8,0]],opacity:0.9,urlPattern:IMAGEOVERLAYROOT+
"smos/%Y/smos2-%Y-%m-%d.png",timeRange:timeRanges["sit-smos"],attribution:'<a href="http://icdc.zmaw.de/l3c_smos_sit.html">University of Hamburg</a>',colorbar:"/images/explorer/cbar-smos.png"}},{"sit-piomas":{enabled:true,index:20,type:"image-overlay",order:450,name:"PIOMAS Thickness",icon:"/images/explorer/maps/sit-smos-icon.png",comment:"Monthly thickness from the PSC's sea ice model",epsg:"3413",bounds:[[38.8,180],[38.8,0]],opacity:0.9,urlPattern:IMAGEOVERLAYROOT+"piomas/%Y/piomas-%Y-%m.png",timeRange:timeRanges["sit-piomas"],
attribution:'<a href="http://psc.apl.washington.edu/wordpress/research/projects/projections-of-an-ice-diminished-arctic-ocean/data-piomas/">PSC</a>',colorbar:"/images/explorer/cbar-cryo.png"}},{"labels-cities":{enabled:true,index:25,type:"marker-overlay",order:500,name:"Cities &amp; Places",icon:"/images/explorer/maps/sic-amsr2-icon.png",comment:"A few significant human settlements",style:"aio-label-marker-red",data:{"Paris":{coords:[48.8569298,2.3412001],lvl:2,style:"-bold"},"London":{coords:[51.506321,
-0.12714],lvl:0,style:"-bold"},"Berlin":{coords:[52.5160713,13.3769798],lvl:0,style:"-bold"},"Copenhagen":{coords:[55.6756783,12.5676003],lvl:2,style:"-bold"},"Oslo":{coords:[59.912281,10.74998],lvl:0,style:"-bold"},"Stockholm":{coords:[59.3323288,18.0629292],lvl:1,style:"-bold"},"Helsinki":{coords:[60.1711617,24.9326496],lvl:0,style:"-bold"},"Moscow":{coords:[55.751709,37.6180229],lvl:0,style:"-bold"},"Nuuk":{coords:[64.1812057,-51.72995],lvl:0,style:"-bold"},"Reykjavik":{coords:[64.1474075,-21.9339905],
lvl:0,style:"-bold"},"Warsaw":{coords:[52.2287483,21.0062504],lvl:2,style:"-bold"},"Ulan Bator":{coords:[47.9221001,106.9169693],lvl:3,style:"-bold"},"Minsk":{coords:[53.8832016,27.5042992],lvl:4,style:"-bold"},"Alert":{coords:[82.5137,-62.332],lvl:1,style:""},"Ambarchik":{coords:[69.6138229,162.2874603],lvl:4,style:""},"Anadyr\u2019":{coords:[64.735672,177.5073853],lvl:3,style:""},"Anchorage":{coords:[61.2175484,-149.8583832],lvl:0,style:""},"Arkhangel\u2019sk":{coords:[64.5377426,40.5155792],lvl:2,
style:""},"Barcelona":{coords:[41.3855782,2.16874],lvl:3,style:""},"Barrow":{coords:[71.2888184,-156.7923737],lvl:1,style:""},"Bordeaux":{coords:[44.8366318,-0.58105],lvl:4,style:""},"Chicago":{coords:[41.8841515,-87.6324081],lvl:3,style:""},"Churchill":{coords:[58.7691193,-94.1679535],lvl:3,style:""},"Cologne":{coords:[50.9416695,6.9551601],lvl:3,style:""},"Edmonton":{coords:[53.5462418,-113.4903717],lvl:3,style:""},"Fairbanks":{coords:[64.8450775,-147.7220612],lvl:4,style:""},"Glasgow":{coords:[55.857811,
-4.2425299],lvl:4,style:""},"Hammerfest":{coords:[70.6623917,23.6835308],lvl:4,style:""},"Inuvik":{coords:[68.3610535,-133.7349243],lvl:3,style:""},"Iqaluit":{coords:[63.753582,-68.502802],lvl:2,style:""},"Irkutsk":{coords:[52.3082504,104.2391434],lvl:2,style:""},"Juneau":{coords:[58.2997398,-134.4067841],lvl:2,style:""},"Kangerlussuaq":{coords:[67.0086111,-50.6891667],lvl:4,style:""},"Kodiak":{coords:[57.79629,-152.41455],lvl:4,style:""},"Labrador City":{coords:[52.9500313,-66.9145126],lvl:3,style:""},
"Longyearbyen":{coords:[78.2185898,15.6487484],lvl:4,style:""},"Minneapolis":{coords:[44.9790306,-93.2649307],lvl:3,style:""},"Murmansk":{coords:[68.9727936,33.0868492],lvl:1,style:""},"Nome":{coords:[64.4994736,-165.4057922],lvl:3,style:""},"Noril'sk":{coords:[69.3473434,88.2070236],lvl:3,style:""},"Okhotsk":{coords:[59.3628998,143.2270813],lvl:4,style:""},"Resolute":{coords:[74.683333,-94.9],lvl:1,style:""},"Surgut":{coords:[61.2549515,73.4354019],lvl:3,style:""},"Tiksi":{coords:[71.6362381,128.8588562],
lvl:0,style:""},"Upermavik":{coords:[72.7913589,-56.1552811],lvl:3,style:""},"Vorkuta":{coords:[67.5015869,64.0609665],lvl:3,style:""},"Winnipeg":{coords:[49.8995285,-97.1411133],lvl:3,style:""},"Yakutsk":{coords:[62.0330429,129.7196808],lvl:3,style:""},"Yellowknife":{coords:[62.4544792,-114.3709488],lvl:3,style:""},"\u00dcr\u00fcmqi":{coords:[43.7878685,87.5862732],lvl:3,style:""}}}},{"labels-features":{enabled:true,index:26,type:"marker-overlay",order:510,name:"Geographic Features",icon:"/images/explorer/maps/sic-amsr2-icon.png",
comment:"Seas, Glaciers, Islands, etc.",style:"aio-label-marker",data:{"Petermann Glacier":{coords:[80.75,-60.75],lvl:0,style:"-magenta"},"Wrangel":{coords:[71.1999969,-179.4799957],lvl:4,style:"-green"},"Jan Mayen":{coords:[70.9710007,-8.4879999],lvl:3,style:"-green"},"Greenland Sea":{coords:[75,-10],lvl:3,style:"-blue"},"Hudson Bay":{coords:[59.9821968,-85.762825],lvl:3,style:"-blue"},"Lincoln Sea":{coords:[83.6,-55],lvl:3,style:"-blue"},"Kara Sea":{coords:[75.4245911,80.4504166],lvl:3,style:"-blue"},
"Barents Sea":{coords:[75,40],lvl:3,style:"-blue"},"Baffin Bay":{coords:[73,-67],lvl:3,style:"-blue"},"Bering Sea":{coords:[59.4500008,-177.6900024],lvl:3,style:"-blue"},"Beaufort Sea":{coords:[70.526108,-141.498886],lvl:3,style:"-blue"},"Chukchi Sea":{coords:[69.37269,-170.39854],lvl:3,style:"-blue"},"Davis Strait":{coords:[60.85101,-63.39802],lvl:3,style:"-blue"},"North Pole":{coords:[90,0],lvl:3,style:"-orange"},"Lake Superior":{coords:[47.5271988,-87.7548981],lvl:4,style:"-blue"},"Laptev Sea":{coords:[75.06545,
126.90263],lvl:3,style:"-blue"},"Magnetic Pole":{coords:[86.395,193.71],lvl:2,style:"-orange"},"Arctic Ocean":{coords:[85,-180],lvl:0,style:"-blue"},"Jakobshavn Glacier":{coords:[69.1666,-49.833],lvl:3,style:"-magenta"},"Helheim Glacier":{coords:[66.35,-38.2],lvl:0,style:"-magenta"},"Zachariae Isstrom":{coords:[78.916667,-21.166667],lvl:3,style:"-magenta"}}}},{"labels-economy":{enabled:true,index:27,type:"marker-overlay",order:520,name:"Resource Extraction",icon:"/images/explorer/maps/sic-amsr2-icon.png",
comment:"EEZs, Oil rigs, mining projects, pipelines, harbours, airports, etc",style:"aio-label-marker",data:{"Isua Project":{coords:[65.188881,-49.7586695],lvl:3,style:"-black",link:""},"Prirazlomnaya":{coords:[69.251944,57.342778],lvl:3,style:"-black",link:""}}}},{"labels-marker":{enabled:true,index:28,type:"marker-overlay",order:530,name:"Wikimarker",icon:"",comment:"",style:"aio-label-marker",data:{"Isua Project":{coords:[65.188881,-49.7586695],lvl:3,style:"-black",link:""},"Prirazlomnaya":{coords:[69.251944,
57.342778],lvl:3,style:"-black",link:""}}}},{"labels-antarctic":{enabled:true,index:29,type:"marker-overlay",order:540,name:"Place Names",icon:"",comment:"",style:"aio-label-marker",data:{"Weddell Sea":{coords:[-73,-45],lvl:3,style:"-blue"},"Ross Sea":{coords:[-75,-175],lvl:3,style:"-blue"},"Davis Sea":{coords:[-66,93.5],lvl:3,style:"-blue"},"Bellingshausen Sea":{coords:[-71,-85],lvl:3,style:"-blue"},"Amundsen Sea":{coords:[-72.5,-111.91667],lvl:3,style:"-blue"},"Byrd Station":{coords:[-80.01667,
-119.53333],lvl:3,style:"-red"},"Georg von Neumayer Station":{coords:[-70.61667,-8.36],lvl:3,style:"-red"},"McMurdo Station":{coords:[-77.85,166.66667],lvl:3,style:"-red"},"Vostok Station":{coords:[-78.46442,106.83733],lvl:3,style:"-red"},"Eilers Peak":{coords:[-80.06667,159.46667],lvl:3,style:"-green"},"Aurora Peak":{coords:[-67.38333,144.2],lvl:3,style:"-green"},"Pine Island Glacier":{coords:[-75,-101],lvl:3,style:"-magenta"},"South Pole":{coords:[-90,0],lvl:3,style:"-orange"}}}}],all:function(key,
type){var i,obj,lay,accu=[];type=type||"base";for(i in Layers[type])if(Layers[type].hasOwnProperty(i)){key=H.firstAttr(Layers[type][i]);lay=Layers[type][i][key];if(lay.enabled){lay.key=key;accu.push(lay)}}return accu},filter:function(fn,sorted){var layers;if(typeof sorted==="undefined")sorted=true;layers=Layers.all().filter(fn);if(sorted)return layers.sort(function(a,b){return a.order-b.order});else return layers},byKey:function(key,type){var i,j,obj;type=type||"base";for(i in Layers[type])if(Layers[type].hasOwnProperty(i))for(j in Layers[type][i])if(Layers[type][i].hasOwnProperty(j))if(j===
key){obj=Layers[type][i][j];obj.key=key;return obj}},byIndex:function(index,type){var i,lay,key;type=type||"base";for(i in Layers[type])if(Layers[type].hasOwnProperty(i)){key=H.firstAttr(Layers[type][i]);lay=Layers[type][i][key];if(lay.index===index){lay.key=key;return lay}}},code2layers:function(code){var i,layers=[];code=H.Base62.toNumber(code);function bit(i,test){return i&1<<test}for(i=0;i<32;i++)if(bit(code,i))layers.push(i);return layers.sort(function(a,b){return a-b})},layers2code:function(layers){var out=
0;if(!layers.length)return null;layers.forEach(function(l){out+=1<<l});return H.Base62.fromNumber(out)},deb:function(){Layers.all().sort(function(a,b){return a.index-b.index}).forEach(function(l){var key="                 "+l.key;var cod=Layers.layers2code([l.index]);console.log(key.substr(key.length-18),"\t",l.index,"\t",cod,"\t",l.order,"\t",JSON.stringify(l.zoom))})}};(function(){var l,n,layers=[];for(l in Layers.base)for(n in Layers.base[l])layers.push(n);TIM.step("LOADED","Layers: "+layers.length)})();
...
zoom,fnDate)]}DEBUG&&console.log("");DEBUG&&console.log("Stat0",curLay.key,">",newKey,curLay.epsg,">",newLay.epsg);if(curLay.key===newKey&&!forceSilent)return;else if(newLay.epsg===curLay.epsg||forceSilent){newCrsTL=newKey==="arc-data"?getMaskCrsTLForMap(othLay.key,othMap):[Crs[newLay.epsg](newLay.zoom),newLay.getTL(newKey,newLay.zoom,fnDate)];othCrsTL=othLay.key==="arc-data"?getMaskCrsTLForMap(newKey,curMap):[];mapR.map.sync();mapL.map.sync();curLayers.splice(0,1);curLayers.unshift(newLay.index);
curLayers.slice(1).forEach(function(idx){var key=Layers.byIndex(idx).key;if(newLay.overlays.indexOf(key)===-1){self.changeOverlay(curMap,key,false,true);self.toggleOverlay(curLayers,key)}else mapR.ctrls.layers._overlays[key]=true});if(isSplitScreen){crsZoomMin=Math.max(curMap.options.crs.options.zoomInfo.min,othMap.options.crs.options.zoomInfo.min);crsZoomMax=Math.min(curMap.options.crs.options.zoomInfo.max,othMap.options.crs.options.zoomInfo.max)}else{crsZoomMin=curMap.options.crs.options.zoomInfo.min;
crsZoomMax=curMap.options.crs.options.zoomInfo.max}status.zoom=H.bounds(status.zoom+curMap.options.crs.options.zoomInfo.min,crsZoomMin,crsZoomMax)-curMap.options.crs.options.zoomInfo.min;ignore.events=true;curMap.removeLayer(curList[curToken]);curMap.options.crs=newCrsTL[0];curMap.addLayer(newCrsTL[1]);curList[newToken]=newCrsTL[1];if(othCrsTL.length){othMap.removeLayer(othList[othToken]);othMap.options.crs=othCrsTL[0];othMap.addLayer(othCrsTL[1]);othList[othToken]=othCrsTL[1]}ignore.events=false;
othZoom=status.zoom;curZoom=status.zoom;othMap.setView([status.lat,status.lng],othZoom,{reset:true,animate:false,zoom:false});curMap.setView([status.lat,status.lng],curZoom,{reset:true,animate:false,zoom:false});if(map===mapR.map)mapR.ctrls.layers.updateActiveLayer(newKey);if(forceSilent)return}else{curLayers.slice(1).forEach(function(idx){var key=Layers.byIndex(idx).key;if(newLay.overlays.indexOf(key)===-1){self.changeOverlay(curMap,key,false,true);self.toggleOverlay(curLayers,key)}else mapR.ctrls.layers._overlays[key]=
true});if(newLay.timeRange)status.day2=status.day1=newLay.timeRange.latest();else{status.day1="";status.day2=""}if(newCrs.options.domain!==curCrs.options.domain){status.lat=llzoom[0];status.lng=llzoom[1];status.zoom=llzoom[2]}self.changeBase(mapR.map,newKey,true);self.changeBase(mapL.map,newKey,true);self.prepBaseList("left");self.updateControls("left");mapR.ctrls.layers.update()}self.updateSplitScreen(isSplitScreen);self.updateTime();self.updateAttribution();self.updatePerma()},prepBaseList:function(side){var base=
side==="right"?Layers.byIndex(status.lay1[0]):Layers.byIndex(status.lay2[0]),mapX=side==="right"?mapR:mapL,dayX=side==="right"?"day1":"day2",filter=side==="right"?function(l){return l.type==="base"}:function(l){return l.type==="base"&&l.epsg===base.epsg},layers=Layers.filter(filter),token;mapX.list={};layers.forEach(function(l){token=side==="right"?l.key:Layers.byKey(l.key).name;mapX.list[token]=l.getTL(l.key,l.zoom,function(){return MAPS.status[dayX]});mapX.list[token].options.side=side;mapX.list[token].options.timeRange=
base.timeRange;mapX.list[token].options.key=l.key})},updateControls:function(side){var mapX=side==="right"?mapR:mapL,indx=side==="right"?status.lay1[0]:status.lay2[0],base=Layers.byIndex(indx);mapX.ctrls.loader=mapX.ctrls.loader||(new L.Control.Loading).addTo(mapX.map);mapX.ctrls.slider=mapX.ctrls.slider||(new L.Control.Zoom).addTo(mapX.map);mapX.ctrls.recticle=mapX.ctrls.recticle||(new L.Control.Recticle).addTo(mapX.map);mapX.ctrls.full=mapX.ctrls.full||(new L.Control.FullScreen).addTo(mapX.map);
mapX.ctrls.split=mapX.ctrls.split||(new L.Control.SplitScreen).addTo(mapX.map);mapX.ctrls.coords=mapX.ctrls.coords||(new L.control.coordinates).addTo(mapX.map);mapX.ctrls.calendar=mapX.ctrls.calendar||(new L.Control.Calendar(utc(status.day1),{timeRange:base.timeRange})).addTo(mapX.map);mapX.ctrls.attribution=mapX.ctrls.attribution||(new L.Control.Attribution({prefix:false})).addTo(mapX.map);if(mapX===mapR)mapR.ctrls.layers=mapR.ctrls.layers||(new L.Control.PrettyLayers(base.key)).addTo(mapR.map).update();
if(mapX===mapL){mapL.ctrls.layers=mapL.ctrls.layers||(new L.Control.SimpleLayers(mapL.list,null,{position:"topright"})).addTo(mapL.map);mapL.ctrls.layers.update=L.Util.falseFn;mapL.ctrls.cursor=mapL.ctrls.cursor||(new L.Control.SplitCursor).addTo(mapL.map)}},createMap:function(side){var mapX=side==="right"?mapR:mapL,base=side==="right"?Layers.byIndex(status.lay1[0]):Layers.byIndex(status.lay2[0]),center=new L.LatLng(status.lat,status.lng),layers,name,key,zoom,$controlContainer;zoom=H.clone(base.zoom);
mapX.timeRange=base.timeRange||new TimeRange;if(side==="right"){mapR.map=new L.Map("mapR",{side:"Right",tms:true,layers:[mapR.list[base.key]],crs:Crs[base.epsg](zoom,"mp-"+base.key),center:center,zoom:status.zoom-zoom.min,fullscreenControl:false,zoomControl:false,zoomsliderControl:false,calendarControl:false,trackResize:false,attributionControl:false});if($(mapR.map._controlContainer).children().length<5){$controlContainer=$(mapR.map._controlContainer);$controlContainer.append('<div class="leaflet-top leaflet-center"></div>');
mapR.map._controlCorners.topcenter=$controlContainer.children(".leaflet-top.leaflet-center").first()[0]}}else{mapL.map=new L.Map("mapL",{side:"Left",layers:[mapL.list[base.name]],tms:true,crs:Crs[base.epsg](zoom,base.key),center:center,zoom:status.zoom-zoom.min,fullscreenControl:false,zoomControl:false,zoomsliderControl:false,calendarControl:false,trackResize:false,attributionControl:false});if($(mapL.map._controlContainer).children().length<5){$controlContainer=$(mapL.map._controlContainer);$controlContainer.append('<div class="leaflet-top leaflet-center"></div>');
mapL.map._controlCorners.topcenter=$controlContainer.children(".leaflet-top.leaflet-center").first()[0]}}},changeSplitScreen:function(){isSplitScreen=!isSplitScreen;self.updateSize();self.updateSplitScreen(isSplitScreen)},updateSplitScreen:function(){var latlng=new L.LatLng(status.lat,status.lng),zoomR=status.zoom-mapR.map.options.crs.options.zoomInfo.min,zoomL=status.zoom-mapL.map.options.crs.options.zoomInfo.min,isTouch=L.Browser.touch;mapR.map.sync();mapL.map.sync();mapL.ctrls.recticle._container.style.visibility=
isSplitScreen?"visible":"hidden";mapL.ctrls.slider._container.style.visibility=isSplitScreen?"visible":"hidden";mapL.ctrls.full._container.style.visibility=isSplitScreen?"visible":"hidden";mapL.ctrls.split._container.style.visibility=isSplitScreen?"visible":"hidden";mapL.ctrls.cursor._container.style.visibility=isTouch?"hidden":isSplitScreen?"visible":"hidden";mapR.ctrls.recticle._container.style.visibility=isSplitScreen?"hidden":"visible";mapR.ctrls.slider._container.style.visibility=isSplitScreen?
"hidden":"visible";mapR.ctrls.full._container.style.visibility=isSplitScreen?"hidden":"visible";mapR.ctrls.split._container.style.visibility=isSplitScreen?"hidden":"visible";if(!isSplitScreen)mapL.ctrls.cursor.deactivate();else{mapL.map.setView([0,0],0,{reset:true,animate:false,zoom:false});mapR.map.sync(mapL.map);mapL.map.sync(mapR.map);mapL.map.setView(latlng,zoomL,{reset:true,animate:false,zoom:false});mapR.map.setView(latlng,zoomR,{reset:true,animate:false,zoom:false})}},activateMap:function(side,
activate){var map=side==="right"?mapR.map:mapL.map,ignoreMap=null;activate=typeof activate==="undefined"?true:false;function getMapX(e){return $(e.target._container).attr("id")==="mapR"?mapR:mapL}function otherMap(map){return map===mapR.map?mapL.map:mapR.map}function coords(map){var c=map.getCenter();return c.lng+", "+c.lat+", "+map.getZoom()}function onMapMouseMove(e,map,side){console.log("EVENT."+side+".move: "+e.latlng)}function onMapZoomStart(e,map,side){}function onMapZoomEnd(e){var mapX=getMapX(e),
lay=Layers.byIndex(mapX===mapR?status.lay1[0]:status.lay2[0]),zoom=lay.zoom,key=lay.key;if(!ignore.events){status.zoom=mapX.map.getZoom();self.updatePerma()}}function onMapMoveEnd(e){var mapX=getMapX(e),c=mapX.map.getCenter();if(!ignore.events){status.lng=c.lng;status.lat=c.lat;self.geocode();self.updatePerma()}}function onMapDragEnd(e,map,side){}function onMapResize(e,map,side){}function onMouseOver(e){var mapX=getMapX(e)}function onMouseOut(e){var mapX=getMapX(e)}function onLayerRemove(e){var mapX=
getMapX(e)}function onLayerAdd(e){var mapX=getMapX(e)}if(activate){map.on("zoomend",onMapZoomEnd);map.on("moveend",onMapMoveEnd);map.on("dragend",onMapDragEnd);map.on("resize",onMapResize);map.on("layeradd",onLayerAdd);map.on("mouseover",onMouseOver);map.on("mouseout",onMouseOut);map.on("layerremove",onLayerRemove);map.on("layeradd",onLayerAdd)}else{map.off("zoomend",onMapZoomEnd);map.off("moveend",onMapMoveEnd);map.off("dragend",onMapDragEnd);map.off("resize",onMapResize);map.off("layeradd",onLayerAdd);
map.off("mouseover",onMouseOver);map.off("mouseout",onMouseOut);map.off("layerremove",onLayerRemove);map.off("layeradd",onLayerAdd)}}}}().boot();
