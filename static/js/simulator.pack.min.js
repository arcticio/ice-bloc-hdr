...
!function(e,t,r,i){var n,o,a,s,d,c,l,u,m,f,g,h,p,v,b,w,y,C,S,k,F,x;n=function(){var i={URL:e.URL||e.webkitURL||e.mozURL||e.msURL,getUserMedia:function(){var e=r.getUserMedia||r.webkitGetUserMedia||r.mozGetUserMedia||r.msGetUserMedia;return e?e.bind(r):e}(),requestAnimFrame:e.requestAnimationFrame||e.webkitRequestAnimationFrame||e.mozRequestAnimationFrame||e.oRequestAnimationFrame||e.msRequestAnimationFrame,requestTimeout:function(e,t){function r(){var i=(new Date).getTime(),s=i-n;s>=t?e.call():o.value=
a(r)}if(e=e||i.noop,t=t||0,!i.requestAnimFrame)return setTimeout(e,t);var n=(new Date).getTime(),o=new Object,a=i.requestAnimFrame;return o.value=a(r),o},Blob:e.Blob||e.BlobBuilder||e.WebKitBlobBuilder||e.MozBlobBuilder||e.MSBlobBuilder,btoa:function(){var t=e.btoa||function(e){for(var t,r,i,n,o,a,s,d="",c=0,l=e.length,u="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=";l>c;)t=e.charCodeAt(c++),r=e.charCodeAt(c++),i=e.charCodeAt(c++),n=t>>2,o=(3&t)<<4|r>>4,a=(15&r)<<2|i>>6,s=63&
i,isNaN(r)?a=s=64:isNaN(i)&&(s=64),d=d+u.charAt(n)+u.charAt(o)+u.charAt(a)+u.charAt(s);return d};return t?t.bind(e):function(){}}(),isObject:function(e){return e&&"[object Object]"===Object.prototype.toString.call(e)},isEmptyObject:function(e){return i.isObject(e)&&!Object.keys(e).length},isArray:function(e){return e&&Array.isArray(e)},isFunction:function(e){return e&&"function"==typeof e},isElement:function(e){return e&&1===e.nodeType},isString:function(e){return"string"==typeof e||"[object String]"===
...
e.canPlayType('video/mp4; codecs="avc1.42E01E, mp4a.40.2"')),r.ogv=""!==e.canPlayType('video/ogg; codecs="theora"'),r.ogg=""!==e.canPlayType('video/ogg; codecs="theora"'),r.webm=-1!==e.canPlayType('video/webm; codecs="vp8, vorbis"'))}catch(i){}return r}()},noop:function(){},each:function(e,t){var r,n;if(i.isArray(e))for(r=-1,n=e.length;++r<n&&t(r,e[r])!==!1;);else if(i.isObject(e))for(r in e)if(e.hasOwnProperty(r)&&t(r,e[r])===!1)break},mergeOptions:function n(e,t){if(i.isObject(e)&&i.isObject(t)&&
Object.keys){var r={};return i.each(e,function(t){r[t]=e[t]}),i.each(t,function(o){var a=t[o];r[o]=i.isObject(a)?e[o]?n(e[o],a):a:a}),r}},setCSSAttr:function(e,t,r){i.isElement(e)&&(i.isString(t)&&i.isString(r)?e.style[t]=r:i.isObject(t)&&i.each(t,function(t,r){e.style[t]=r}))},removeElement:function(e){i.isElement(e)&&e.parentNode&&e.parentNode.removeChild(e)},createWebWorker:function(e){if(!i.isString(e))return{};try{var t=new i.Blob([e],{type:"text/javascript"}),r=i.URL.createObjectURL(t),n=new Worker(r);
return{objectUrl:r,worker:n}}catch(o){return""+o}},getExtension:function(e){return e.substr(e.lastIndexOf(".")+1,e.length)},getFontSize:function(e){if(e=e||{},!t.body||e.resizeFont===!1)return e.fontSize;var r=e.text,i=e.gifWidth,n=parseInt(e.fontSize,10),o=parseInt(e.minFontSize,10),a=t.createElement("div"),s=t.createElement("span");for(a.setAttribute("width",i),a.appendChild(s),s.innerHTML=r,s.style.fontSize=n+"px",s.style.textIndent="-9999px",s.style.visibility="hidden",t.body.appendChild(s);s.offsetWidth>
i&&n>=o;)s.style.fontSize=--n+"px";return t.body.removeChild(s),n+"px"},webWorkerError:!1};return i}(),o=function(e){var t={validate:function(r){r=e.isObject(r)?r:{};var i={};return e.each(t.validators,function(e,t){var n=t.errorCode;return r[n]||t.condition?void 0:(i=t,i.error=!0,!1)}),delete i.condition,i},isValid:function(e){var r=t.validate(e),i=r.error!==!0?!0:!1;return i},validators:[{condition:e.isFunction(e.getUserMedia),errorCode:"getUserMedia",errorMsg:"The getUserMedia API is not supported in your browser"},
{condition:e.isSupported.canvas(),errorCode:"canvas",errorMsg:"Canvas elements are not supported in your browser"},{condition:e.isSupported.webworkers(),errorCode:"webworkers",errorMsg:"The Web Workers API is not supported in your browser"},{condition:e.isFunction(e.URL),errorCode:"window.URL",errorMsg:"The window.URL API is not supported in your browser"},{condition:e.isSupported.blob(),errorCode:"window.Blob",errorMsg:"The window.Blob File API is not supported in your browser"},{condition:e.isSupported.Uint8Array(),
errorCode:"window.Uint8Array",errorMsg:"The window.Uint8Array function constructor is not supported in your browser"},{condition:e.isSupported.Uint32Array(),errorCode:"window.Uint32Array",errorMsg:"The window.Uint32Array function constructor is not supported in your browser"}],messages:{videoCodecs:{errorCode:"videocodec",errorMsg:"The video codec you are trying to use is not supported in your browser"}}};return t}(n),a={sampleInterval:10,numWorkers:2,gifWidth:200,gifHeight:200,interval:0.1,numFrames:10,
keepCameraOn:!1,images:[],video:null,webcamVideoElement:null,cameraStream:null,text:"",fontWeight:"normal",fontSize:"16px",minFontSize:"10px",resizeFont:!1,fontFamily:"sans-serif",fontColor:"#ffffff",textAlign:"center",textBaseline:"bottom",textXCoordinate:null,textYCoordinate:null,progressCallback:function(){},completeCallback:function(){},saveRenderingContexts:!1,savedRenderingContexts:[],crossOrigin:"Anonymous"},s=function(){return o.isValid()},d=function(){return o.isValid()},c=function(){var e=
{getUserMedia:!0};return o.isValid(e)},l=function(e){var t=!1;if(n.isArray(e)&&e.length){if(n.each(e,function(e,r){n.isSupported.videoCodecs[r]&&(t=!0)}),!t)return!1}else if(n.isString(e)&&e.length&&!n.isSupported.videoCodecs[e])return!1;return o.isValid({getUserMedia:!0})},u=function(){function e(){function e(e,t,r){var i,n;for(u=e,m=t,f=r,g=new Array(h),i=0;h>i;i++)g[i]=new Array(4),n=g[i],n[0]=n[1]=n[2]=(i<<S+8)/h|0,D[i]=x/h|0,G[i]=0}function t(){for(var e=[],t=new Array(h),r=0;h>r;r++)t[g[r][3]]=
r;for(var i=0,n=0;h>n;n++){var o=t[n];e[i++]=g[o][0],e[i++]=g[o][1],e[i++]=g[o][2]}return e}function r(){var e,t,r,i,n,o,a,s;for(a=0,s=0,e=0;h>e;e++){for(n=g[e],r=e,i=n[1],t=e+1;h>t;t++)o=g[t],o[1]<i&&(r=t,i=o[1]);if(o=g[r],e!=r&&(t=o[0],o[0]=n[0],n[0]=t,t=o[1],o[1]=n[1],n[1]=t,t=o[2],o[2]=n[2],n[2]=t,t=o[3],o[3]=n[3],n[3]=t),i!=a){for(B[a]=s+e>>1,t=a+1;i>t;t++)B[t]=e;a=i,s=e}}for(B[a]=s+C>>1,t=a+1;256>t;t++)B[t]=C}function i(){var e,t,r,i,n,o,a,g,h,C,F,x,E,W;for(y>m&&(f=1),l=30+(f-1)/3,x=u,E=0,W=
m,F=m/(3*f),C=F/k|0,g=j,o=I,a=o>>R,1>=a&&(a=0),e=0;a>e;e++)q[e]=g*((a*a-e*e)*z/(a*a));for(h=y>m?3:m%p!==0?3*p:m%v!==0?3*v:m%b!==0?3*b:3*w,e=0;F>e;)if(r=(255&x[E+0])<<S,i=(255&x[E+1])<<S,n=(255&x[E+2])<<S,t=c(r,i,n),d(g,t,r,i,n),0!==a&&s(a,t,r,i,n),E+=h,E>=W&&(E-=m),e++,0===C&&(C=1),e%C===0)for(g-=g/l,o-=o/T,a=o>>R,1>=a&&(a=0),t=0;a>t;t++)q[t]=g*((a*a-t*t)*z/(a*a))}function n(e,t,r){var i,n,o,a,s,d,c;for(s=1E3,c=-1,i=B[t],n=i-1;h>i||n>=0;)h>i&&(d=g[i],o=d[1]-t,o>=s?i=h:(i++,0>o&&(o=-o),a=d[0]-e,0>
a&&(a=-a),o+=a,s>o&&(a=d[2]-r,0>a&&(a=-a),o+=a,s>o&&(s=o,c=d[3])))),n>=0&&(d=g[n],o=t-d[1],o>=s?n=-1:(n--,0>o&&(o=-o),a=d[0]-e,0>a&&(a=-a),o+=a,s>o&&(a=d[2]-r,0>a&&(a=-a),o+=a,s>o&&(s=o,c=d[3]))));return c}function o(){return i(),a(),r(),t()}function a(){var e;for(e=0;h>e;e++)g[e][0]>>=S,g[e][1]>>=S,g[e][2]>>=S,g[e][3]=e}function s(e,t,r,i,n){var o,a,s,d,c,l,u;for(s=t-e,-1>s&&(s=-1),d=t+e,d>h&&(d=h),o=t+1,a=t-1,l=1;d>o||a>s;){if(c=q[l++],d>o){u=g[o++];try{u[0]-=c*(u[0]-r)/P|0,u[1]-=c*(u[1]-i)/P|0,
u[2]-=c*(u[2]-n)/P|0}catch(m){}}if(a>s){u=g[a--];try{u[0]-=c*(u[0]-r)/P|0,u[1]-=c*(u[1]-i)/P|0,u[2]-=c*(u[2]-n)/P|0}catch(m){}}}}function d(e,t,r,i,n){var o=g[t],a=e/j;o[0]-=a*(o[0]-r)|0,o[1]-=a*(o[1]-i)|0,o[2]-=a*(o[2]-n)|0}function c(e,t,r){var i,n,o,a,s,d,c,l,u,m;for(l=~(1<<31),u=l,d=-1,c=d,i=0;h>i;i++)m=g[i],n=m[0]-e,0>n&&(n=-n),o=m[1]-t,0>o&&(o=-o),n+=o,o=m[2]-r,0>o&&(o=-o),n+=o,l>n&&(l=n,d=i),a=n-(G[i]>>F-S),u>a&&(u=a,c=i),s=D[i]>>W,D[i]-=s,G[i]+=s<<E;return D[d]+=O,G[d]-=A,c}var l,u,m,f,g,
h=256,p=499,v=491,b=487,w=503,y=3*w,C=h-1,S=4,k=100,F=16,x=1<<F,E=10,W=10,O=x>>W,A=x<<E-W,U=h>>3,R=6,M=1<<R,I=U*M,T=30,V=10,j=1<<V,H=8,z=1<<H,L=V+H,P=1<<L,B=[],G=[],D=[],q=[];e.apply(this,arguments);var N={};return N.map=n,N.process=o,N}return e}(),m=function(e){var t=function(){try{self.onmessage=function(e){var t,i=e.data||{};i.gifshot&&(t=r.run(i),postMessage(t))}}catch(t){}var r={dataToRGB:function(e,t,r){for(var i=0,n=t*r*4,o=[];n>i;)o.push(e[i++]),o.push(e[i++]),o.push(e[i++]),i++;return o},
componentizedPaletteToArray:function(e){var t,r,i,n,o=[];for(t=0;t<e.length;t+=3)r=e[t],i=e[t+1],n=e[t+2],o.push(r<<16|i<<8|n);return o},processFrameWithQuantizer:function(t,r,i,n){var o,a,s,d,c=this.dataToRGB(t,r,i),l=new e(c,c.length,n),u=l.process(),m=new Uint32Array(this.componentizedPaletteToArray(u)),f=r*i,g=new Uint8Array(f),h=0;for(o=0;f>o;o++)a=c[h++],s=c[h++],d=c[h++],g[o]=l.map(a,s,d);return{pixels:g,palette:m}},run:function(e){var t=e.width,r=e.height,i=e.data,n=(e.palette,e.sampleInterval);
return this.processFrameWithQuantizer(i,t,r,n)}};return r};return t}(u),f=function(e,t,r,n){function o(e){var t=e.length;if(2>t||t>256||t&t-1)throw"Invalid code/color length, must be power of 2 and 2 .. 256.";return t}function a(e,t,r,n){function o(r){for(;f>=r;)e[t++]=255&g,g>>=8,f-=8,t===s+256&&(e[s]=255,s=t++)}function a(e){g|=e<<f,f+=m,o(8)}e[t++]=r;var s=t++,d=1<<r,c=d-1,l=d+1,u=l+1,m=r+1,f=0,g=0,h=n[0]&c,p={};a(d);for(var v=1,b=n.length;b>v;++v){var w=n[v]&c,y=h<<8|w,C=p[y];if(C===i){for(g|=
h<<f,f+=m;f>=8;)e[t++]=255&g,g>>=8,f-=8,t===s+256&&(e[s]=255,s=t++);4096===u?(a(d),u=l+1,m=r+1,p={}):(u>=1<<m&&++m,p[y]=u++),h=w}else h=C}return a(h),a(l),o(1),s+1===t?e[s]=0:(e[s]=t-s-1,e[t++]=0),t}var s=0;n=n===i?{}:n;var d=n.loop===i?null:n.loop,c=n.palette===i?null:n.palette;if(0>=t||0>=r||t>65535||r>65535)throw"Width/Height invalid.";e[s++]=71,e[s++]=73,e[s++]=70,e[s++]=56,e[s++]=57,e[s++]=97;var l=0,u=0;if(e[s++]=255&t,e[s++]=t>>8&255,e[s++]=255&r,e[s++]=r>>8&255,e[s++]=(null!==c?128:0)|l,e[s++]=
u,e[s++]=0,null!==d){if(0>d||d>65535)throw"Loop count invalid.";e[s++]=33,e[s++]=255,e[s++]=11,e[s++]=78,e[s++]=69,e[s++]=84,e[s++]=83,e[s++]=67,e[s++]=65,e[s++]=80,e[s++]=69,e[s++]=50,e[s++]=46,e[s++]=48,e[s++]=3,e[s++]=1,e[s++]=255&d,e[s++]=d>>8&255,e[s++]=0}var m=!1;this.addFrame=function(t,r,n,d,l,u){if(m===!0&&(--s,m=!1),u=u===i?{}:u,0>t||0>r||t>65535||r>65535)throw"x/y invalid.";if(0>=n||0>=d||n>65535||d>65535)throw"Width/Height invalid.";if(l.length<n*d)throw"Not enough pixels for the frame size.";
var f=!0,g=u.palette;if((g===i||null===g)&&(f=!1,g=c),g===i||null===g)throw"Must supply either a local or global palette.";for(var h=o(g),p=0;h>>=1;)++p;h=1<<p;var v=u.delay===i?0:u.delay,b=u.disposal===i?0:u.disposal;if(0>b||b>3)throw"Disposal out of range.";var w=!1,y=0;if(u.transparent!==i&&null!==u.transparent&&(w=!0,y=u.transparent,0>y||y>=h))throw"Transparent color index.";if((0!==b||w||0!==v)&&(e[s++]=33,e[s++]=249,e[s++]=4,e[s++]=b<<2|(w===!0?1:0),e[s++]=255&v,e[s++]=v>>8&255,e[s++]=y,e[s++]=
0),e[s++]=44,e[s++]=255&t,e[s++]=t>>8&255,e[s++]=255&r,e[s++]=r>>8&255,e[s++]=255&n,e[s++]=n>>8&255,e[s++]=255&d,e[s++]=d>>8&255,e[s++]=f===!0?128|p-1:0,f===!0)for(var C=0,S=g.length;S>C;++C){var k=g[C];e[s++]=k>>16&255,e[s++]=k>>8&255,e[s++]=255&k}s=a(e,s,2>p?2:p,l)},this.end=function(){return m===!1&&(e[s++]=59,m=!0),s}},g=function(e,r,i,n){var o=function(t){this.canvas=null,this.ctx=null,this.repeat=0,this.frames=[],this.numRenderedFrames=0,this.onRenderCompleteCallback=e.noop,this.onRenderProgressCallback=
e.noop,this.workers=[],this.availableWorkers=[],this.generatingGIF=!1,this.options=t,this.initializeWebWorkers(t)};return o.prototype={workerMethods:r(),initializeWebWorkers:function(n){var o,a,s,d,c=i.toString()+"("+r.toString()+"());",l=-1,u="";for(d=n.numWorkers;++l<d;)o=e.createWebWorker(c),e.isObject(o)?(a=o.objectUrl,s=o.worker,this.workers.push({worker:s,objectUrl:a}),this.availableWorkers.push(s)):(u=o,e.webWorkerError=!!o);this.workerError=u,this.canvas=t.createElement("canvas"),this.canvas.width=
n.gifWidth,this.canvas.height=n.gifHeight,this.ctx=this.canvas.getContext("2d"),this.frames=[]},getWorker:function(){return this.availableWorkers.pop()},freeWorker:function(e){this.availableWorkers.push(e)},byteMap:function(){for(var e=[],t=0;256>t;t++)e[t]=String.fromCharCode(t);return e}(),bufferToString:function(e){for(var t=e.length,r="",i=-1;++i<t;)r+=this.byteMap[e[i]];return r},onFrameFinished:function(t){var r=this,i=r.frames,n=r.options;hasExistingImages=!!(n.images||[]).length,allDone=i.every(function(e){return!e.beingProcessed&&
e.done}),r.numRenderedFrames++,hasExistingImages&&t(r.numRenderedFrames/i.length),r.onRenderProgressCallback(0.75*r.numRenderedFrames/i.length),allDone?r.generatingGIF||r.generateGIF(i,r.onRenderCompleteCallback):e.requestTimeout(function(){r.processNextFrame()},1)},processFrame:function(e){var t,r,i=this,n=this.options,o=n.progressCallback,a=n.sampleInterval,s=this.frames,d=function(e){var n=e.data;delete t.data,t.pixels=Array.prototype.slice.call(n.pixels),t.palette=Array.prototype.slice.call(n.palette),
t.done=!0,t.beingProcessed=!1,i.freeWorker(r),i.onFrameFinished(o)};return t=s[e],t.beingProcessed||t.done?(this.onFrameFinished(),void 0):(t.sampleInterval=a,t.beingProcessed=!0,t.gifshot=!0,r=this.getWorker(),r?(r.onmessage=d,r.postMessage(t)):d({data:i.workerMethods.run(t)}),void 0)},startRendering:function(e){this.onRenderCompleteCallback=e;for(var t=0;t<this.options.numWorkers&&t<this.frames.length;t++)this.processFrame(t)},processNextFrame:function(){for(var e=-1,t=0;t<this.frames.length;t++){var r=
this.frames[t];if(!r.done&&!r.beingProcessed){e=t;break}}e>=0&&this.processFrame(e)},generateGIF:function(t,r){var i,o,a=[],s={loop:this.repeat},d=this.options,c=d.interval,l=d.images,u=!!l.length,m=d.gifHeight,f=d.gifWidth,g=new n(a,f,m,s),h=this.onRenderProgressCallback,p=u?100*c:0;this.generatingGIF=!0,e.each(t,function(e,r){var i=r.palette;h(0.75+0.25*r.position*1/t.length),g.addFrame(0,0,f,m,r.pixels,{palette:i,delay:p})}),g.end(),h(1),this.frames=[],this.generatingGIF=!1,e.isFunction(r)&&(i=
this.bufferToString(a),o="data:image/gif;base64,"+e.btoa(i),r(o))},setRepeat:function(e){this.repeat=e},addFrame:function(t,r){r=e.isObject(r)?r:{};var i,n=this,o=n.ctx,a=n.options,s=a.gifWidth,d=a.gifHeight,c=(r.gifHeight,r.gifWidth,r.text),l=r.fontWeight,u=e.getFontSize(r),m=r.fontFamily,f=r.fontColor,g=r.textAlign,h=r.textBaseline,p=r.textXCoordinate?r.textXCoordinate:"left"===g?1:"right"===g?s:s/2,v=r.textYCoordinate?r.textYCoordinate:"top"===h?1:"center"===h?d/2:d,b=l+" "+u+" "+m;try{o.drawImage(t,
0,0,s,d),c&&(o.font=b,o.fillStyle=f,o.textAlign=g,o.textBaseline=h,o.fillText(c,p,v)),i=o.getImageData(0,0,s,d),n.addFrameImageData(i)}catch(w){return""+w}},addFrameImageData:function(e){var t=this.frames,r=e.data;this.frames.push({data:r,width:e.width,height:e.height,palette:null,dithering:null,done:!1,beingProcessed:!1,position:t.length})},onRenderProgress:function(e){this.onRenderProgressCallback=e},isRendering:function(){return this.generatingGIF},getBase64GIF:function(t){var r=this,i=function(i){r.destroyWorkers(),
e.requestTimeout(function(){t(i)},0)};r.startRendering(i)},destroyWorkers:function(){if(!this.workerError){var t=this.workers;e.each(t,function(t,r){var i=r.worker,n=r.objectUrl;i.terminate(),e.URL.revokeObjectURL(n)})}}},o}(n,m,u,f),h=function(e,t){e.getBase64GIF(function(e){t({error:!1,errorCode:"",errorMsg:"",image:e})})},p=function(e){function r(){n.each(p,function(e,t){t&&s.addFrame(t,u)}),h(s,l)}var a,s,d=e.images,c=e.imagesLength,l=e.callback,u=e.options,m={getUserMedia:!0,"window.URL":!0},
f=o.validate(m),p=[],v=0;return f.error?l(f):(s=new g(u),n.each(d,function(e,o){n.isElement(o)?(u.crossOrigin&&(o.crossOrigin=u.crossOrigin),p[e]=o,v+=1,v===c&&r()):n.isString(o)&&(a=t.createElement("img"),u.crossOrigin&&(a.crossOrigin=u.crossOrigin),a.onerror=function(){p.length>e&&(p[e]=i)}(function(t){t.onload=function(){p[e]=t,v+=1,v===c&&r(),n.removeElement(t)}}(a)),a.src=o,n.setCSSAttr(a,{position:"fixed",opacity:"0"}),t.body.appendChild(a))}),void 0)},v={getGIF:function(e,r){r=n.isFunction(r)?
r:n.noop;var i,o=t.createElement("canvas"),a=e.images,s=!!a.length,d=e.videoElement,c=e.keepCameraOn,l=e.webcamVideoElement,u=e.cameraStream,m=+e.gifWidth,f=+e.gifHeight,h=e.videoWidth,p=e.videoHeight,v=(+e.sampleInterval,+e.numWorkers,e.crop),b=+e.interval,w=s?0:1E3*b,y=e.progressCallback,C=e.savedRenderingContexts,S=e.saveRenderingContexts,k=[],F=C.length?C.length:e.numFrames,x=F,E=new g(e),W=e.text,O=e.fontWeight,A=n.getFontSize(e),U=e.fontFamily,R=e.fontColor,M=e.textAlign,I=e.textBaseline,T=
e.textXCoordinate?e.textXCoordinate:"left"===M?1:"right"===M?m:m/2,V=e.textYCoordinate?e.textYCoordinate:"top"===I?1:"center"===I?f/2:f,j=O+" "+A+" "+U,H=v?Math.floor(v.scaledWidth/2):0,z=v?h-v.scaledWidth:0,L=v?Math.floor(v.scaledHeight/2):0,P=v?p-v.scaledHeight:0,B=function G(){function e(){try{z>h&&(z=h),P>p&&(P=p),0>H&&(H=0),0>L&&(L=0),i.drawImage(d,H,L,z,P,0,0,m,f),t()}catch(r){if("NS_ERROR_NOT_AVAILABLE"!==r.name)throw r;n.requestTimeout(e,100)}}function t(){x=o;var t,a,s,g,h=F-x;S&&k.push(i.getImageData(0,
0,m,f)),W&&(i.font=j,i.fillStyle=R,i.textAlign=M,i.textBaseline=I,i.fillText(W,T,V)),t=i.getImageData(0,0,m,f),a=t.data,s=a[0]+a[1]+a[2]+a[3],g=0===s,g?1===h&&1===F&&e():E.addFrameImageData(t),y(h/F),o>0&&n.requestTimeout(G,w),x||E.getBase64GIF(function(e){r({error:!1,errorCode:"",errorMsg:"",image:e,cameraStream:u,videoElement:d,webcamVideoElement:l,savedRenderingContexts:k,keepCameraOn:c})})}var o=x-1;C.length?(i.putImageData(C[F-x],0,0),t()):e()};F=null!=F?F:10,b=null!=b?b:0.1,o.width=m,o.height=
f,i=o.getContext("2d"),function D(){return C.length||0!==d.currentTime?(B(),void 0):(n.requestTimeout(D,100),void 0)}()},getCropDimensions:function(e){var t=e.videoWidth,r=e.videoHeight,i=e.gifWidth,n=e.gifHeight,o={width:0,height:0,scaledWidth:0,scaledHeight:0};return t>r?(o.width=Math.round(t*(n/r))-i,o.scaledWidth=Math.round(o.width*(r/n))):(o.height=Math.round(r*(i/t))-n,o.scaledHeight=Math.round(o.height*(t/i))),o}},b={loadedData:!1,defaultVideoDimensions:{width:640,height:480},findVideoSize:function E(e){E.attempts=
E.attempts||0;var t=this,r=e.videoElement,i=e.cameraStream,o=e.completedCallback;r&&(r.videoWidth>0&&r.videoHeight>0?(r.removeEventListener("loadeddata",t.findVideoSize),o({videoElement:r,cameraStream:i,videoWidth:r.videoWidth,videoHeight:r.videoHeight})):E.attempts<10?(E.attempts+=1,n.requestTimeout(function(){t.findVideoSize(e)},200)):o({videoElement:r,cameraStream:i,videoWidth:t.defaultVideoDimensions.width,videoHeight:t.defaultVideoDimensions.height}))},onStreamingTimeout:function(e){n.isFunction(e)&&
e({error:!0,errorCode:"getUserMedia",errorMsg:"There was an issue with the getUserMedia API - Timed out while trying to start streaming",image:null,cameraStream:{}})},stream:function(e){var t=this,r=n.isArray(e.existingVideo)?e.existingVideo[0]:e.existingVideo,i=e.videoElement,o=e.cameraStream,a=e.streamedCallback,s=e.completedCallback;n.isFunction(a)&&a(),r?n.isString(r)&&(i.src=r,i.innerHTML='<source src="'+r+'" type="video/'+n.getExtension(r)+'" />'):i.mozSrcObject?i.mozSrcObject=o:n.URL&&(i.src=
n.URL.createObjectURL(o)),i.play(),n.requestTimeout(function d(){d.count=d.count||0,t.loadedData===!0?(t.findVideoSize({videoElement:i,cameraStream:o,completedCallback:s}),t.loadedData=!1):(d.count+=1,d.count>10?t.findVideoSize({videoElement:i,cameraStream:o,completedCallback:s}):d())},100)},startStreaming:function(e){var r=this,i=n.isFunction(e.error)?e.error:n.noop,o=n.isFunction(e.streamed)?e.streamed:n.noop,a=n.isFunction(e.completed)?e.completed:n.noop,s=e.existingVideo,d=e.webcamVideoElement,
...
t){t=t||{};var r,o=this,a=t.timeout!==i?t.timeout:0,s=t.callback,d=t.webcamVideoElement;a>0&&(r=n.requestTimeout(function(){o.onStreamingTimeout(s)},1E4)),this.startStreaming({error:function(){s({error:!0,errorCode:"getUserMedia",errorMsg:"There was an issue with the getUserMedia API - the user probably denied permission",image:null,cameraStream:{}})},streamed:function(){clearTimeout(r)},completed:function(t){var r=t.cameraStream,i=t.videoElement,n=t.videoWidth,o=t.videoHeight;e({cameraStream:r,videoElement:i,
videoWidth:n,videoHeight:o})},lastCameraStream:t.lastCameraStream,webcamVideoElement:d,crossOrigin:t.crossOrigin,options:t})},stopVideoStreaming:function(e){e=n.isObject(e)?e:{};var t=e.cameraStream,r=e.videoElement,i=e.keepCameraOn,o=e.webcamVideoElement;!i&&t&&n.isFunction(t.stop)&&t.stop(),n.isElement(r)&&!o&&(r.pause(),n.isFunction(n.URL.revokeObjectURL)&&!n.webWorkerError&&r.src&&n.URL.revokeObjectURL(r.src),n.removeElement(r))}},w=function(e){e=n.isObject(e)?e:{};var t=(n.isObject(e.options)?
e.options:{},e.cameraStream),r=e.videoElement,i=e.webcamVideoElement,o=e.keepCameraOn;b.stopVideoStreaming({cameraStream:t,videoElement:r,keepCameraOn:o,webcamVideoElement:i})},y=function(e,r){var i=e.options||{},o=i.images,a=i.video,s=(+i.numFrames,e.cameraStream),d=e.videoElement,c=e.videoWidth,l=e.videoHeight,u=+i.gifWidth,m=+i.gifHeight,f=v.getCropDimensions({videoWidth:c,videoHeight:l,gifHeight:m,gifWidth:u}),g=r;i.crop=f,i.videoElement=d,i.videoWidth=c,i.videoHeight=l,i.cameraStream=s,n.isElement(d)&&
(d.width=u+f.width,d.height=m+f.height,i.webcamVideoElement||(n.setCSSAttr(d,{position:"fixed",opacity:"0"}),t.body.appendChild(d)),d.play(),v.getGIF(i,function(e){o&&o.length||a&&a.length||w(e),g(e)}))},C=function(e){var t,r,i=e.existingVideo,a=e.callback,s=e.options,d={getUserMedia:!0,"window.URL":!0},c=o.validate(d);if(c.error)return a(c);if(n.isElement(i)&&i.src){if(r=i.src,t=n.getExtension(r),!n.isSupported.videoCodecs[t])return a(o.messages.videoCodecs)}else n.isArray(i)&&n.each(i,function(e,
r){return t=r.substr(r.lastIndexOf(".")+1,r.length),n.isSupported.videoCodecs[t]?(i=r,!1):void 0});b.startStreaming({completed:function(e){e.options=s||{},y(e,a)},existingVideo:i,crossOrigin:s.crossOrigin,options:s})},S=function(e){var t=e.lastCameraStream,r=e.callback,i=e.webcamVideoElement,n=e.options;return d()?n.savedRenderingContexts.length?(v.getWebcamGIF(n,function(e){r(e)}),void 0):(b.startVideoStreaming(function(e){e.options=n||{},y(e,r)},{lastCameraStream:t,callback:r,webcamVideoElement:i,
crossOrigin:n.crossOrigin}),void 0):r(o.validate())},k=function(e,t){if(t=n.isFunction(e)?e:t,e=n.isObject(e)?e:{},n.isFunction(t)){var r=n.mergeOptions(a,e)||{},i=e.cameraStream,o=r.images,s=o?o.length:0,d=r.video,c=r.webcamVideoElement;r=n.mergeOptions(r,{gifWidth:Math.floor(r.gifWidth),gifHeight:Math.floor(r.gifHeight)}),s?p({images:o,imagesLength:s,callback:t,options:r}):d?C({existingVideo:d,callback:t,options:r}):S({lastCameraStream:i,callback:t,webcamVideoElement:c,options:r})}},F=function(e,
t){if(t=n.isFunction(e)?e:t,e=n.isObject(e)?e:{},n.isFunction(t)){var r=n.mergeOptions(a,e),i=n.mergeOptions(r,{interval:0.1,numFrames:1,gifWidth:Math.floor(r.gifWidth),gifHeight:Math.floor(r.gifHeight)});k(i,t)}},x=function(e,t,r,i,n,o,a,s,d,c){var l={utils:e,error:t,defaultOptions:r,createGIF:s,takeSnapShot:d,stopVideoStreaming:c,isSupported:i,isWebCamGIFSupported:n,isExistingVideoGIFSupported:a,isExistingImagesGIFSupported:o,VERSION:"0.3.2"};return l}(n,o,a,s,d,c,l,k,F,w),function(t){"function"==
typeof define&&define.amd?define([],function(){return t}):"undefined"!=typeof exports?module.exports=t:e.gifshot=t}(x)}("undefined"!=typeof window?window:{},"undefined"!=typeof document?document:{createElement:function(){}},"undefined"!=typeof window?window.navigator:{});
...
b,c,d){this._defaultsKey=a;this.parent=d;this._eventListeners=[];d={};c&&Y[c]&&Y[c][a]&&(d=Y[c][a]);this._options=b?b:{};this.setOptions(this._options,d)}function u(a,b,c){this._publicChartReference=c;b=b||{};u.base.constructor.call(this,"Chart",b,b.theme?b.theme:"theme1");var d=this;this._containerId=a;this._objectsInitialized=!1;this.overlaidCanvasCtx=this.ctx=null;this._indexLabels=[];this._panTimerId=0;this._lastTouchEventType="";this._lastTouchData=null;this.isAnimating=!1;this.renderCount=0;
this.panEnabled=this.disableToolTip=this.animatedRender=!1;this._defaultCursor="default";this.plotArea={canvas:null,ctx:null,x1:0,y1:0,x2:0,y2:0,width:0,height:0};this._dataInRenderedOrder=[];(this._container="string"===typeof this._containerId?document.getElementById(this._containerId):this._containerId)?(this._container.innerHTML="",b=a=0,a=this._options.width?this.width:0<this._container.clientWidth?this._container.clientWidth:this.width,b=this._options.height?this.height:0<this._container.clientHeight?
...
mousemove:this._plotAreaMouseMove,cursor:this.zoomEnabled?"col-resize":"move",cursor:this.panEnabled?"move":"default",capture:!0,bounds:this.plotArea})};u.prototype.categoriseDataSeries=function(){for(var a="",b=0;b<this.data.length;b++)if(a=this.data[b],a.dataPoints&&0!==a.dataPoints.length&&a.visible&&0<=u._supportedChartTypes.indexOf(a.type)){for(var c=null,d=!1,e=null,f=!1,g=0;g<this.plotInfo.plotTypes.length;g++)if(this.plotInfo.plotTypes[g].type===a.type){d=!0;c=this.plotInfo.plotTypes[g];break}d||
...
e=0;k=!1;for(y=0;y<l.length;y++)g=q[(c+y)%l.length],1<a&&g.midAngle>Math.PI/2-t&&g.midAngle<Math.PI/2+t&&(e<=a/2&&!k?(g.hemisphere="right",e++):(g.hemisphere="left",k=!0));k=!1;for(y=0;y<l.length;y++)g=q[(d+y)%l.length],1<b&&g.midAngle>3*Math.PI/2-t&&g.midAngle<3*Math.PI/2+t&&(f<=b/2&&!k?(g.hemisphere="left",f++):(g.hemisphere="right",k=!0))}}function c(a){var b=p.plotArea.ctx;b.clearRect(n.x1,n.y1,n.width,n.height);b.fillStyle=p.backgroundColor;b.fillRect(n.x1,n.y1,n.width,n.height);for(b=0;b<l.length;b++){var c=
q[b].startAngle,d=q[b].endAngle;if(d>c){var e=0.07*z*Math.cos(q[b].midAngle),f=0.07*z*Math.sin(q[b].midAngle),g=!1;if(l[b].exploded){if(1.0E-9<Math.abs(q[b].center.x-(x.x+e))||1.0E-9<Math.abs(q[b].center.y-(x.y+f)))q[b].center.x=x.x+e*a,q[b].center.y=x.y+f*a,g=!0}else if(0<Math.abs(q[b].center.x-x.x)||0<Math.abs(q[b].center.y-x.y))q[b].center.x=x.x+e*(1-a),q[b].center.y=x.y+f*(1-a),g=!0;g&&(e={},e.dataSeries=h,e.dataPoint=h.dataPoints[b],e.index=b,p._toolTip.highlightObjects([e]));sa(p.plotArea.ctx,
q[b].center,q[b].radius,l[b].color?l[b].color:h._colorSet[b%h._colorSet.length],h.type,c,d,h.fillOpacity,q[b].percentInnerRadius)}}a=p.plotArea.ctx;a.save();a.fillStyle="black";a.strokeStyle="grey";a.textBaseline="middle";a.lineJoin="round";for(b=b=0;b<l.length;b++)c=q[b],c.indexLabelText&&(c.indexLabelTextBlock.y-=c.indexLabelTextBlock.height/2,d=0,d="left"===c.hemisphere?"inside"!==h.indexLabelPlacement?-(c.indexLabelTextBlock.width+m):-c.indexLabelTextBlock.width/2:"inside"!==h.indexLabelPlacement?
m:-c.indexLabelTextBlock.width/2,c.indexLabelTextBlock.x+=d,c.indexLabelTextBlock.render(!0),c.indexLabelTextBlock.x-=d,c.indexLabelTextBlock.y+=c.indexLabelTextBlock.height/2,"inside"!==c.indexLabelPlacement&&0<c.indexLabelLineThickness&&(d=c.center.x+z*Math.cos(c.midAngle),e=c.center.y+z*Math.sin(c.midAngle),a.strokeStyle=c.indexLabelLineColor,a.lineWidth=c.indexLabelLineThickness,a.setLineDash&&a.setLineDash(M(c.indexLabelLineDashType,c.indexLabelLineThickness)),a.beginPath(),a.moveTo(d,e),a.lineTo(c.indexLabelTextBlock.x,
c.indexLabelTextBlock.y),a.lineTo(c.indexLabelTextBlock.x+("left"===c.hemisphere?-m:m),c.indexLabelTextBlock.y),a.stroke()),a.lineJoin="miter");a.save()}function d(a,b){var c=0,c=a.indexLabelTextBlock.y-a.indexLabelTextBlock.height/2,d=a.indexLabelTextBlock.y+a.indexLabelTextBlock.height/2,e=b.indexLabelTextBlock.y-b.indexLabelTextBlock.height/2,f=b.indexLabelTextBlock.y+b.indexLabelTextBlock.height/2;return c=b.indexLabelTextBlock.y>a.indexLabelTextBlock.y?e-d:c-f}function e(a){for(var b=null,c=
1;c<l.length;c++)if(b=(a+c+q.length)%q.length,q[b].hemisphere!==q[a].hemisphere){b=null;break}else if(q[b].indexLabelText&&b!==a&&(0>d(q[b],q[a])||("right"===q[a].hemisphere?q[b].indexLabelTextBlock.y>=q[a].indexLabelTextBlock.y:q[b].indexLabelTextBlock.y<=q[a].indexLabelTextBlock.y)))break;else b=null;return b}function f(a,b,c){c=(c||0)+1;if(1E3<c)return 0;b=b||0;var g=0,h=x.y-1*indexLabelRadius,k=x.y+1*indexLabelRadius;if(0<=a&&a<l.length){var m=q[a];if(0>b&&m.indexLabelTextBlock.y<h||0<b&&m.indexLabelTextBlock.y>
k)return 0;var n=0,p=0,p=n=n=0;0>b?m.indexLabelTextBlock.y-m.indexLabelTextBlock.height/2>h&&m.indexLabelTextBlock.y-m.indexLabelTextBlock.height/2+b<h&&(b=-(h-(m.indexLabelTextBlock.y-m.indexLabelTextBlock.height/2+b))):m.indexLabelTextBlock.y+m.indexLabelTextBlock.height/2<h&&m.indexLabelTextBlock.y+m.indexLabelTextBlock.height/2+b>k&&(b=m.indexLabelTextBlock.y+m.indexLabelTextBlock.height/2+b-k);b=m.indexLabelTextBlock.y+b;h=0;h="right"===m.hemisphere?x.x+Math.sqrt(Math.pow(indexLabelRadius,2)-
Math.pow(b-x.y,2)):x.x-Math.sqrt(Math.pow(indexLabelRadius,2)-Math.pow(b-x.y,2));p=x.x+z*Math.cos(m.midAngle);n=x.y+z*Math.sin(m.midAngle);n=Math.sqrt(Math.pow(h-p,2)+Math.pow(b-n,2));p=Math.acos(z/indexLabelRadius);n=Math.acos((indexLabelRadius*indexLabelRadius+z*z-n*n)/(2*z*indexLabelRadius));b=n<p?b-m.indexLabelTextBlock.y:0;h=null;for(k=1;k<l.length;k++)if(h=(a-k+q.length)%q.length,q[h].hemisphere!==q[a].hemisphere){h=null;break}else if(q[h].indexLabelText&&q[h].hemisphere===q[a].hemisphere&&
h!==a&&(0>d(q[h],q[a])||("right"===q[a].hemisphere?q[h].indexLabelTextBlock.y<=q[a].indexLabelTextBlock.y:q[h].indexLabelTextBlock.y>=q[a].indexLabelTextBlock.y)))break;else h=null;p=h;n=e(a);k=h=0;0>b?(k="right"===m.hemisphere?p:n,g=b,null!==k&&(p=-b,b=m.indexLabelTextBlock.y-m.indexLabelTextBlock.height/2-(q[k].indexLabelTextBlock.y+q[k].indexLabelTextBlock.height/2),b-p<r&&(h=-p,k=f(k,h,c+1),+k.toFixed(v)>+h.toFixed(v)&&(g=b>r?-(b-r):-(p-(k-h)))))):0<b&&(k="right"===m.hemisphere?n:p,g=b,null!==
k&&(p=b,b=q[k].indexLabelTextBlock.y-q[k].indexLabelTextBlock.height/2-(m.indexLabelTextBlock.y+m.indexLabelTextBlock.height/2),b-p<r&&(h=p,k=f(k,h,c+1),+k.toFixed(v)<+h.toFixed(v)&&(g=b>r?b-r:p-(h-k)))));g&&(c=m.indexLabelTextBlock.y+g,b=0,b="right"===m.hemisphere?x.x+Math.sqrt(Math.pow(indexLabelRadius,2)-Math.pow(c-x.y,2)):x.x-Math.sqrt(Math.pow(indexLabelRadius,2)-Math.pow(c-x.y,2)),m.midAngle>Math.PI/2-t&&m.midAngle<Math.PI/2+t?(h=(a-1+q.length)%q.length,h=q[h],a=q[(a+1+q.length)%q.length],"left"===
m.hemisphere&&"right"===h.hemisphere&&b>h.indexLabelTextBlock.x?b=h.indexLabelTextBlock.x-15:"right"===m.hemisphere&&"left"===a.hemisphere&&b<a.indexLabelTextBlock.x&&(b=a.indexLabelTextBlock.x+15)):m.midAngle>3*Math.PI/2-t&&m.midAngle<3*Math.PI/2+t&&(h=(a-1+q.length)%q.length,h=q[h],a=q[(a+1+q.length)%q.length],"right"===m.hemisphere&&"left"===h.hemisphere&&b<h.indexLabelTextBlock.x?b=h.indexLabelTextBlock.x+15:"left"===m.hemisphere&&"right"===a.hemisphere&&b>a.indexLabelTextBlock.x&&(b=a.indexLabelTextBlock.x-
15)),m.indexLabelTextBlock.y=c,m.indexLabelTextBlock.x=b,m.indexLabelAngle=Math.atan2(m.indexLabelTextBlock.y-x.y,m.indexLabelTextBlock.x-x.x))}return g}function g(){var a=p.plotArea.ctx;a.fillStyle="grey";a.strokeStyle="grey";a.font="16px Arial";a.textBaseline="middle";for(var b=a=0,c=0,g=!0,b=0;10>b&&(1>b||0<c);b++){if(h.radius||!h.radius&&"undefined"!==typeof h.innerRadius&&null!==h.innerRadius&&z-c<=A)g=!1;g&&(z-=c);c=0;if("inside"!==h.indexLabelPlacement){indexLabelRadius=z*s;for(a=0;a<l.length;a++){var k=
q[a];k.indexLabelTextBlock.x=x.x+indexLabelRadius*Math.cos(k.midAngle);k.indexLabelTextBlock.y=x.y+indexLabelRadius*Math.sin(k.midAngle);k.indexLabelAngle=k.midAngle;k.radius=z;k.percentInnerRadius=D}for(var t,w,a=0;a<l.length;a++){var k=q[a],u=e(a);if(null!==u){t=q[a];w=q[u];var y=0,y=d(t,w)-r;if(0>y){for(var B=w=0,C=0;C<l.length;C++)C!==a&&q[C].hemisphere===k.hemisphere&&(q[C].indexLabelTextBlock.y<k.indexLabelTextBlock.y?w++:B++);w=y/(w+B||1)*B;var B=-1*(y-w),E=C=0;"right"===k.hemisphere?(C=f(a,
w),B=-1*(y-C),E=f(u,B),+E.toFixed(v)<+B.toFixed(v)&&+C.toFixed(v)<=+w.toFixed(v)&&f(a,-(B-E))):(C=f(u,w),B=-1*(y-C),E=f(a,B),+E.toFixed(v)<+B.toFixed(v)&&+C.toFixed(v)<=+w.toFixed(v)&&f(u,-(B-E)))}}}}else for(a=0;a<l.length;a++)k=q[a],indexLabelRadius="pie"===h.type?0.7*z:0.8*z,u=x.x+indexLabelRadius*Math.cos(k.midAngle),w=x.y+indexLabelRadius*Math.sin(k.midAngle),k.indexLabelTextBlock.x=u,k.indexLabelTextBlock.y=w;for(a=0;a<l.length;a++)if(k=q[a],u=k.indexLabelTextBlock.measureText(),0!==u.height&&
0!==u.width)u=u=0,"right"===k.hemisphere?(u=n.x2-(k.indexLabelTextBlock.x+k.indexLabelTextBlock.width+m),u*=-1):u=n.x1-(k.indexLabelTextBlock.x-k.indexLabelTextBlock.width-m),0<u&&(!g&&k.indexLabelText&&(w="right"===k.hemisphere?n.x2-k.indexLabelTextBlock.x:k.indexLabelTextBlock.x-n.x1,0.3*k.indexLabelTextBlock.maxWidth>w?k.indexLabelText="":k.indexLabelTextBlock.maxWidth=0.85*w,0.3*k.indexLabelTextBlock.maxWidth<w&&(k.indexLabelTextBlock.x-="right"===k.hemisphere?2:-2)),Math.abs(k.indexLabelTextBlock.y-
...
' opacity="',c,'"',' joinstyle="',a.lineJoin,'"',' miterlimit="',a.miterLimit,'"',' endcap="',$[a.lineCap]||"square",'"',' weight="',e,'px"',' color="',g,'" />')}function T(a,b,c,g){var e=a.fillStyle,f=a.arcScaleX_,d=a.arcScaleY_,k=g.x-c.x,n=g.y-c.y;if(e instanceof w){var h=0,l=g=0,u=0,m=1;if("gradient"==e.type_){h=e.x1_/f;c=e.y1_/d;var p=s(a,e.x0_/f,e.y0_/d),h=s(a,h,c),h=180*Math.atan2(h.x-p.x,h.y-p.y)/Math.PI;0>h&&(h+=360);1.0E-6>h&&(h=0)}else p=s(a,e.x0_,e.y0_),g=(p.x-c.x)/k,l=(p.y-c.y)/n,k/=f*
q,n/=d*q,m=x.max(k,n),u=2*e.r0_/m,m=2*e.r1_/m-u;f=e.colors_;f.sort(function(a,b){return a.offset-b.offset});d=f.length;p=f[0].color;c=f[d-1].color;k=f[0].alpha*a.globalAlpha;a=f[d-1].alpha*a.globalAlpha;for(var n=[],r=0;r<d;r++){var t=f[r];n.push(t.offset*m+u+" "+t.color)}b.push('<g_vml_:fill type="',e.type_,'"',' method="none" focus="100%"',' color="',p,'"',' color2="',c,'"',' colors="',n.join(","),'"',' opacity="',a,'"',' g_o_:opacity2="',k,'"',' angle="',h,'"',' focusposition="',g,",",l,'" />')}else e instanceof
...
SIM.Vars={tmp2m:{color:"#C24642",legend:"Temperature (2m, \u00b0C)",axis:"primary",letter:"T",unit:"C",adjust:function(d){return d-273.15},name:"Temperature, 2m",description:"2 m above ground temperature [k]",wiki:null},prmslmsl:{color:"#369EAD",legend:"Pressure (msl)",axis:"secondary",letter:"P",unit:"hpa",range:[950,1050],adjust:function(d){return d/100},name:"Sea Level Pressure",description:"mean sea level pressure reduced to msl [hpa]",wiki:null},apcpsfc:{color:"#76cee2",legend:"Precipitation (kg/m^2)",
axis:"primary",letter:"PC",unit:"kg/m^2",adjust:null,name:null,description:"surface total precipitation [kg/m^2]",wiki:null},gustsfc:{range:[0,30],color:"#6cef6c",legend:"SFC wind speed (gust, m/s)",axis:"secondary",letter:"G",unit:"m/s",adjust:null,name:null,description:"surface wind speed (gust) [m/s] ",wiki:null},dlwrfsfc:{range:[0,0.5,1,1.5],color:"#ffbb55",legend:"Long wave (down, kw/m^2)",axis:"primary",letter:"LW",unit:"kw/m^2",adjust:function(d){return d/1E3},name:null,description:"surface downward long-wave rad. flux [w/m^2]",
wiki:null},dswrfsfc:{range:[0,0.5,1,1.5],color:"#ce9be5",legend:"Short wave (down, kw/m^2)",axis:"secondary",letter:"SW",unit:"kw/m^2",adjust:function(d){return d/1E3},name:null,description:"surface downward short-wave rad. flux [w/m^2]",wiki:null},absvprs:{unit:"1/s",adjust:null,name:null,description:"(1000 975 950 925 900.. 7 5 3 2 1) absolute vorticity [1/s]",wiki:null},no4lftxsfc:{unit:"k",adjust:null,name:null,description:"surface best (4 layer) lifted index [k]",wiki:"http://en.wikipedia.org/wiki/Lifted_index"},
...
name:null,description:"surface latent heat net flux [w/m^2]",wiki:null},o3mrprs:{unit:"kg/kg",adjust:null,name:null,description:"(100 70 50 30 20 10 7 5 3 2 1) ozone mixing ratio [kg/kg]",wiki:null},pevprsfc:{unit:"w/m^2",adjust:null,name:null,description:"surface potential evaporation rate [w/m^2]",wiki:null},potsig995:{unit:"C",adjust:function(d){return d-273.15},name:null,description:"0.995 sigma level potential temperature [k]",wiki:null},pratesfc:{unit:"g/m^2/s",adjust:function(d){return d*1E3},
name:null,description:"surface precipitation rate [g/m^2/s]",wiki:null},preslclb:{unit:"hpa",adjust:function(d){return d/100},name:null,description:"low cloud bottom level pressure [hpa]",wiki:null},preslclt:{unit:"hpa",adjust:function(d){return d/100},name:null,description:"low cloud top level pressure [hpa]",wiki:null},presmclb:{unit:"hpa",adjust:function(d){return d/100},name:null,description:"middle cloud bottom level pressure [hpa]",wiki:null},presmclt:{unit:"hpa",adjust:function(d){return d/
100},name:null,description:"middle cloud top level pressure [hpa]",wiki:null},preshclb:{unit:"hpa",adjust:function(d){return d/100},name:null,description:"high cloud bottom level pressure [hpa]",wiki:null},preshclt:{unit:"hpa",adjust:function(d){return d/100},name:null,description:"high cloud top level pressure [hpa]",wiki:null},pressfc:{unit:"hpa",adjust:function(d){return d/100},name:"Surface Pressure",description:"surface pressure [hpa]",wiki:null},pres2pv:{unit:"hpa",adjust:function(d){return d/
100},name:null,description:"pv=2e-06 (km^2/kg/s) surface pressure [hpa]",wiki:null},presneg2pv:{unit:"hpa",adjust:function(d){return d/100},name:null,description:"pv=-2e-06 (km^2/kg/s) surface pressure [hpa]",wiki:null},pres0p5pv:{unit:"hpa",adjust:function(d){return d/100},name:null,description:"pv=5e-07 (km^2/kg/s) surface pressure [hpa]",wiki:null},presneg0p5pv:{unit:"hpa",adjust:function(d){return d/100},name:null,description:"pv=-5e-07 (km^2/kg/s) surface pressure [hpa]",wiki:null},pres1pv:{unit:"hpa",
adjust:function(d){return d/100},name:null,description:"pv=1e-06 (km^2/kg/s) surface pressure [hpa]",wiki:null},presneg1pv:{unit:"hpa",adjust:function(d){return d/100},name:null,description:"pv=-1e-06 (km^2/kg/s) surface pressure [hpa]",wiki:null},pres1p5pv:{unit:"hpa",adjust:function(d){return d/100},name:null,description:"pv=1.5e-06 (km^2/kg/s) surface pressure [hpa]",wiki:null},presneg1p5pv:{unit:"hpa",adjust:function(d){return d/100},name:null,description:"pv=-1.5e-06 (km^2/kg/s) surface pressure [hpa]",
wiki:null},prescclb:{unit:"hpa",adjust:function(d){return d/100},name:null,description:"convective cloud bottom level pressure [hpa]",wiki:null},prescclt:{unit:"hpa",adjust:function(d){return d/100},name:null,description:"convective cloud top level pressure [hpa]",wiki:null},presmwl:{unit:"hpa",adjust:function(d){return d/100},name:null,description:"max wind pressure [hpa]",wiki:null},prestrop:{unit:"hpa",adjust:function(d){return d/100},name:null,description:"tropopause pressure [hpa]",wiki:null},
...
tcdclcll:{unit:"%",adjust:null,name:null,description:"low cloud layer total cloud cover [%]",wiki:null},tcdcmcll:{unit:"%",adjust:null,name:null,description:"middle cloud layer total cloud cover [%]",wiki:null},tcdchcll:{unit:"%",adjust:null,name:null,description:"high cloud layer total cloud cover [%]",wiki:null},tcdcccll:{unit:"%",adjust:null,name:null,description:"convective cloud layer total cloud cover [%]",wiki:null},tmax2m:{unit:"C",adjust:function(d){return d-273.15},name:"Temperature, max, 2m",
description:"2 m above ground maximum temperature [k]",wiki:null},tmin2m:{unit:"C",adjust:function(d){return d-273.15},name:"Temperature, min, 2m",description:"2 m above ground minimum temperature [k]",wiki:null},tmplclt:{unit:"C",adjust:function(d){return d-273.15},name:null,description:"low cloud top level temperature [k]",wiki:null},tmpmclt:{unit:"C",adjust:function(d){return d-273.15},name:null,description:"middle cloud top level temperature [k]",wiki:null},tmphclt:{unit:"C",adjust:function(d){return d-
273.15},name:null,description:"high cloud top level temperature [k]",wiki:null},tmpsfc:{unit:"C",adjust:function(d){return d-273.15},name:"Surface Temperature",description:"surface temperature [k]",wiki:null},tmpprs:{unit:"C",adjust:function(d){return d-273.15},name:null,description:"(1000 975 950 925 900.. 7 5 3 2 1) temperature [k]",wiki:null},tmp_1829m:{unit:"C",adjust:function(d){return d-273.15},name:null,description:"1829 m above mean sea level temperature [k]",wiki:null},tmp_2743m:{unit:"C",
adjust:function(d){return d-273.15},name:null,description:"2743 m above mean sea level temperature [k]",wiki:null},tmp_3658m:{unit:"C",adjust:function(d){return d-273.15},name:null,description:"3658 m above mean sea level temperature [k]",wiki:null},tmp_305m:{unit:"C",adjust:function(d){return d-273.15},name:null,description:"305 m above mean sea level temperature [k]",wiki:null},tmp_457m:{unit:"C",adjust:function(d){return d-273.15},name:null,description:"457 m above mean sea level temperature [k]",
wiki:null},tmp_610m:{unit:"C",adjust:function(d){return d-273.15},name:null,description:"610 m above mean sea level temperature [k]",wiki:null},tmp_914m:{unit:"C",adjust:function(d){return d-273.15},name:null,description:"914 m above mean sea level temperature [k]",wiki:null},tmp_4572m:{unit:"C",adjust:function(d){return d-273.15},name:null,description:"4572 m above mean sea level temperature [k]",wiki:null},tmpsig995:{unit:"C",adjust:function(d){return d-273.15},name:null,description:"0.995 sigma level temperature [k]",
wiki:null},tmp0_10cm:{unit:"C",adjust:function(d){return d-273.15},name:null,description:"0-0.1 m below ground temperature [k]",wiki:null},tmp10_40cm:{unit:"C",adjust:function(d){return d-273.15},name:null,description:"0.1-0.4 m below ground temperature [k]",wiki:null},tmp40_100cm:{unit:"C",adjust:function(d){return d-273.15},name:null,description:"0.4-1 m below ground temperature [k]",wiki:null},tmp100_200cm:{unit:"C",adjust:function(d){return d-273.15},name:null,description:"1-2 m below ground temperature [k]",
wiki:null},tmp30_0mb:{unit:"C",adjust:function(d){return d-273.15},name:null,description:"30-0 mb above ground temperature [k]",wiki:null},tmp60_30mb:{unit:"C",adjust:function(d){return d-273.15},name:null,description:"60-30 mb above ground temperature [k]",wiki:null},tmp90_60mb:{unit:"C",adjust:function(d){return d-273.15},name:null,description:"90-60 mb above ground temperature [k]",wiki:null},tmp120_90mb:{unit:"C",adjust:function(d){return d-273.15},name:null,description:"120-90 mb above ground temperature [k]",
wiki:null},tmp150_120mb:{unit:"C",adjust:function(d){return d-273.15},name:null,description:"150-120 mb above ground temperature [k]",wiki:null},tmp180_150mb:{unit:"C",adjust:function(d){return d-273.15},name:null,description:"180-150 mb above ground temperature [k]",wiki:null},tmp2pv:{unit:"C",adjust:function(d){return d-273.15},name:null,description:"pv=2e-06 (km^2/kg/s) surface temperature [k]",wiki:null},tmpneg2pv:{unit:"C",adjust:function(d){return d-273.15},name:null,description:"pv=-2e-06 (km^2/kg/s) surface temperature [k]",
wiki:null},tmp0p5pv:{unit:"C",adjust:function(d){return d-273.15},name:null,description:"pv=5e-07 (km^2/kg/s) surface temperature [k]",wiki:null},tmpneg0p5pv:{unit:"C",adjust:function(d){return d-273.15},name:null,description:"pv=-5e-07 (km^2/kg/s) surface temperature [k]",wiki:null},tmp1pv:{unit:"C",adjust:function(d){return d-273.15},name:null,description:"pv=1e-06 (km^2/kg/s) surface temperature [k]",wiki:null},tmpneg1pv:{unit:"C",adjust:function(d){return d-273.15},name:null,description:"pv=-1e-06 (km^2/kg/s) surface temperature [k]",
wiki:null},tmp1p5pv:{unit:"C",adjust:function(d){return d-273.15},name:null,description:"pv=1.5e-06 (km^2/kg/s) surface temperature [k]",wiki:null},tmpneg1p5pv:{unit:"C",adjust:function(d){return d-273.15},name:null,description:"pv=-1.5e-06 (km^2/kg/s) surface temperature [k]",wiki:null},tmpmwl:{unit:"C",adjust:function(d){return d-273.15},name:null,description:"max wind temperature [k]",wiki:null},tmptrop:{unit:"C",adjust:function(d){return d-273.15},name:null,description:"tropopause temperature [k]",
...
name:null,description:"tropopause vertical speed sheer [1/s]",wiki:null},watrsfc:{unit:"kg/m^2",adjust:null,name:null,description:"surface water runoff [kg/m^2]",wiki:null},weasdsfc:{unit:"kg/m^2",adjust:null,name:null,description:"surface water equivalent of accumulated snow depth [kg/m^2]",wiki:null},wiltsfc:{unit:"fraction",adjust:null,name:null,description:"surface wilting point [fraction]",wiki:null}};"use strict";
SIM.Blobs=function(filename,onprogress,onfinish){this.vars={};this.scheme=["sMagic","dDay","iSteps","iCount"];this.loadFile(filename,onprogress,onfinish)};
SIM.Blobs.prototype={constructor:SIM.Blobs,makeUrl:function(filename){var suffix=DEVELOP?"?DEV":"";if(filename.split("/")[0]==="1970")return"/data/simulation/"+filename+suffix;else return"//noiv.pythonanywhere.com/cors/simulation/"+filename+suffix},loadFile:function(filename,onprogress,onfinish){var self=this,loaded=0,head,data,header,req=new XMLHttpRequest;req.open("GET",this.makeUrl(filename),true);req.responseType="arraybuffer";req.onload=function(){head=new Uint8Array(req.response.slice(0,128));
header=String.fromCharCode.apply(null,head);data=req.response.slice(128);self.parse(header,data);onfinish(this)};req.onprogress=function(e){e.diff=e.loaded-loaded;loaded=e.loaded;onprogress(e)};req.send()},parse:function(fileHeader,fileData){var i,t,item,vari,pointer=0,tArray,length=0,name,tokens=fileHeader.split(" ").filter(function(l){return l.length});for(i=0;i<this.scheme.length;i++){t=this.scheme[i].slice(0,1);name=this.scheme[i].slice(1);this[name]=t==="s"?tokens[i]:t==="i"?~~tokens[i]:t===
"f"?parseFloat(tokens[i]):t==="d"?H.iso2Day(tokens[i]):console.error("Can't parse:",tokens)}for(i=0;i<this.Count;i++){item=tokens[i+4].split(":");vari={name:item[0],bits:~~item[1],grid:~~item[2],steps:this.Steps,doe:~~(this.Day/864E5),shape:[this.Steps,~~item[2],~~item[2]]};tArray=vari.bits===8?Int8Array:vari.bits===16?Int16Array:vari.bits===32?Float32Array:vari.bits===64?Float64Array:console.error("Unknow ArrayType",tokens);length=vari.steps*vari.grid*vari.grid*vari.bits/8;vari.data=new tArray(fileData.slice(pointer,
pointer+length));pointer+=length;this.vars[vari.name]=vari}}};SIM.MArray=function(){this.data={};this.cache={};this.doe=NaN;this.slice=NaN;this.grid=NaN;this.factor=NaN;this.min=+1E6;this.max=-1E6};
SIM.MArray.prototype={constructor:SIM.MArray,bytes:function(){var result=0;Object.keys(this.data).forEach(function(doe){result+=this.data[doe].length*this.data[doe].BYTES_PER_ELEMENT},this);return result},sorter:function(a,b){return a<b?1:-1},first:function(){var doe=Object.keys(this.data).sort(this.sorter)[0];return this.data[doe]},setDateSize:function(date,size){this.doe=H.date2doe(date);this.slice=~~(date.getUTCHours()/(24/this.data[this.doe].shape[0]));this.grid=this.data[this.doe].shape[1];this.factor=
(this.grid-1)/size},analyzeDoe:function(doe){var i,d,cube=this.data[doe],len=cube.length;cube.min=+1E6;cube.max=-1E6;for(i=0;i<len;i++){d=cube[i];cube.min=d<cube.min?d:cube.min;cube.max=d>cube.max?d:cube.max}this.min=cube.min<this.min?cube.min:this.min;this.max=cube.max>this.max?cube.max:this.max},getXY:function(x,y){var cube=this.data[this.doe],grid=cube.shape[1];return cube[this.slice*grid*grid+x+(grid-y-1)*grid]},interpolateXY:function(x,y){var cube=this.data[this.doe],grid=this.grid,offset=this.slice*
grid*grid,gx=x*this.factor,gy=y*this.factor,dx=gx-~~gx,dy=gy-~~gy,xi0=~~(gx%grid),yi0=~~(gy%grid),xi1=xi0+1,yi1=yi0+1,val=cube[offset+xi0+(grid-yi0-1)*grid]*(1-dx)*(1-dy)+cube[offset+xi1+(grid-yi0-1)*grid]*dx*(1-dy)+cube[offset+xi0+(grid-yi1-1)*grid]*(1-dx)*dy+cube[offset+xi1+(grid-yi1-1)*grid]*dx*dy;return val},__interpolateXY:function(x,y){var gx=x*this.factor,gy=y*this.factor,dx=gx-~~gx,dy=gy-~~gy,xi0=~~(gx%this.grid),yi0=~~(gy%this.grid),xi1=xi0+1,yi1=yi0+1,val=this.getXY(xi0,yi0)*(1-dx)*(1-dy)+
this.getXY(xi1,yi0)*dx*(1-dy)+this.getXY(xi0,yi1)*(1-dx)*dy+this.getXY(xi1,yi1)*dx*dy;return val}};"use strict";
SIM.Blender=function(){var self,images=null,size=NaN,doe=NaN,slice=NaN,doeMin=+1E6,doeMax=-1E6,doesSorted=null;return{boot:function(){return self=this},makeUrl:function(iso){var suffix=DEVELOP?"?DEV":"";var year=iso.slice(0,4);return"//noiv.pythonanywhere.com/cors/amsr2/"+year+"_0125_masked/amsr2-"+iso+".png"+suffix},closestDoe:function(doe){var i,lower,upper,len=doesSorted.length;for(i=1;i<len;i++)if(doesSorted[i]>doe){lower=doesSorted[i-1];upper=doesSorted[i];return Math.abs(lower-doe)<Math.abs(upper-
doe)?lower:upper}},loadImage:function(iso,onfinish){var doe,img,url=self.makeUrl(iso);$.ajax({type:"HEAD",async:true,url:url,crossDomain:true,headers:{}}).done(function(message,text,xhr){var mime=xhr.getResponseHeader("Content-Type");if(mime==="image/png"){img=new Image;img.crossOrigin="anonymous";img.onload=function(){doe=H.iso2doe(iso);images[doe]=img;onfinish()};img.onerror=function(){doe=H.iso2doe(iso);console.log("SIM.Blender.onerror:",iso);onfinish()};img.src=url}else onfinish()}).fail(function(xhr,
text,error){console.log("loadImage.fail",xhr,text,error);onfinish()})},loadRange:function(isoRange,progress,onfinish){var loaded=0,sorter=function(a,b){return a<b?1:-1};images={};isoRange.forEach(function(url){self.loadImage(url,function(){loaded+=1;progress(loaded);if(loaded===isoRange.length){doesSorted=Object.keys(images).sort(sorter);if(doesSorted.length){doeMax=doesSorted.slice(0)[0];doeMin=doesSorted.slice(-1)[0];TIM.step("LOADED",["SIM.Blender:",doeMin,"->",doeMax].join(" "))}else{images=null;
TIM.step("LOADED",["SIM.Blender:","nothing"].join(" "))}onfinish()}})})},setDateSize:function(date,cvssize){var hours=date.getUTCHours();size=cvssize;doe=H.date2doe(date);slice=hours===0?0:hours===6?0.25:hours===12?0.5:1},blend:function(ctx,totalAlpha){var doeClose,oldAlpha=ctx.globalAlpha;if(!images)return;if(images[doe]&&images[doe+1]){ctx.globalAlpha=totalAlpha-totalAlpha*slice;ctx.drawImage(images[doe],0,0,size,size);ctx.globalAlpha=totalAlpha*slice;ctx.drawImage(images[doe+1],0,0,size,size);
ctx.globalAlpha=oldAlpha}else{doeClose=doe<=doeMin?doeMin:doe>=doeMax?doeMax:self.closestDoe(doe);ctx.globalAlpha=0.05;ctx.drawImage(images[doeClose],0,0,size,size);ctx.globalAlpha=oldAlpha}}}}().boot();
SIM.Model=function(){var self,server="//ice-pics.appspot.com/nomads",configs={"0.25d_1h":{name:"0.25d_1h",url:"",resolution:0.25,root:server+"/gfs_0p25_1hr",timeRange:120,timeDistance:1,timeSteps:120},"0.25d_3h":{name:"0.25d_3h",url:"",resolution:0.25,root:server+"/gfs_0p25",timeRange:56,timeDistance:2,timeSteps:28}},cfg=configs["0.25d_1h"];return{boot:function(){return self=this},sync:function(callback){var response;SIM.Syncer.sync(cfg,function(err,subfolder){if(err)return;response=subfolder.slice(0,
8)+"_"+subfolder.slice(-3);cfg.url=cfg.root+"/gfs"+subfolder;callback(response)})},get:function(url,callback){var req=new XMLHttpRequest;req.open("GET",url);req.send(null);req.onload=function(){callback(null,req.responseText)};req.onerror=function(e){callback(e,null)}},getForecast:function(lat,lng,chartinfo,callback){lng=lng<0?180+(lng+180):lng;var tasks,nLat=~~H.scale(lat,-90,+90,0,720)+"",nLng=~~H.scale(lng,0,+360,0,1440-1)+"",cons=H.format("[0:%s:%s][%s][%s]",cfg.timeDistance,cfg.timeRange-1,nLat,
nLng),vari2url=function(vari){return cfg.url+".ascii?"+vari+cons};DEBUG&&console.log("model.getForecast cons/lat/lon",cons,~~lat,~~lng);tasks=chartinfo.varis.map(vari2url).map(function(url){return function(callback){self.get(url,function(err,dods){if(err){callback(err,null);return}var errs=self.parseForErrors(dods);if(errs)callback(errs,null);else callback(null,[chartinfo,self.parseSingleDods(dods)])})}});async.parallel(tasks,callback)},toDate:function(datum){var day=parseInt(datum,10),flt=parseFloat(datum),
scs=(flt-day)*24*60*60,utc=new Date(Date.UTC(-1,0,day,0,0,scs)),year=utc.getUTCFullYear();utc.setUTCFullYear(year+2);return utc},stripHours:function(date){return new Date(Date.UTC(date.getUTCFullYear(),date.getUTCMonth(),date.getUTCDate()))},parseSingleDods:function(dods){var token,numFloat,datagramm={},lines=dods.split("\n").filter(function(l){return l.trim().length}),vari=lines[0].split(",")[0],lng=parseFloat(lines[cfg.timeSteps+6]);datagramm.datas=[];datagramm.vari=vari;datagramm.stamps=lines[cfg.timeSteps+
2].split(", ").map(self.toDate);datagramm.lat=parseFloat(lines[cfg.timeSteps+4]);datagramm.lng=lng>180?-180+(lng-180):lng;lines.slice(1,cfg.timeSteps+1).forEach(function(line){token=line.split(", ")[1];numFloat=token==="9.999E20"?NaN:parseFloat(token);datagramm.datas.push(SIM.Vars[vari].adjust?SIM.Vars[vari].adjust(numFloat):numFloat)});datagramm.min=Math.min.apply(Math,datagramm.datas.filter(function(n){return!isNaN(n)}));datagramm.max=Math.max.apply(Math,datagramm.datas.filter(function(n){return!isNaN(n)}));
datagramm.minDate=self.stripHours(datagramm.stamps[0]);return datagramm},parseForErrors:function(text){var nodes=$.parseHTML(text),errors=nodes.filter(function(node){return(node.innerText||node.innerHTML||"").toLowerCase().indexOf("error")!==-1});return!errors.length?null:errors.map(function(e){return e.innerHTML})}}}().boot();
SIM.Syncer=function(){var self;return{boot:function(){return self=this},get:function(url,callback){var req=new XMLHttpRequest;req.open("GET",url);req.send(null);req.onload=function(){callback(null,req.responseText)};req.onerror=function(e){callback(e,null)}},parseForErrors:function(text){var nodes=$.parseHTML(text),errors=nodes.filter(function(node){return(node.innerText||node.innerHTML||"").toLowerCase().indexOf("error")!==-1});return!errors.length?null:errors.map(function(e){return e.innerHTML})},
sync:function(cfg,callback){self.get(cfg.root,function(err,text){var title,errors,nodes,dayurl,last,runs;if(err){callback(err,null);return}if(errors=self.parseForErrors(text)){TIM.step("FAILED","GFS Latest: ");callback(err,null);return}nodes=$.parseHTML(text);title=nodes.filter(function(node){return node.nodeName==="TITLE"})[0].innerHTML;if(title.toLowerCase().indexOf("error")!==-1){TIM.step("FAILED","GFS Latest: ");console.log("Model.sync: title:",title);return}last=nodes.filter(function(node){return node.nodeName===
"B"}).map(function(node){var l=node.innerHTML.length;return node.innerHTML.slice(l-10,l-2)}).sort().slice(-1)[0];dayurl=cfg.root+"/gfs"+last;TIM.step("SYNCED","GFS Day: "+dayurl.split("/").slice(-1)[0]);self.get(dayurl,function(err,text){if(err){callback&&callback(err,null);return}runs=$.parseHTML(text).filter(function(node){return node.nodeName==="B"&&node.innerHTML.indexOf("anl")===-1}).map(function(node){var l=node.innerHTML.length;return cfg.name==="0.25d_1h"?node.innerHTML.slice(l-17,l-1):node.innerHTML.slice(l-
13,l-1)}).sort().slice(-1);TIM.step("SYNCED","GFS Run: "+runs[0]);callback(null,last+"/"+runs[0])})})}}}().boot();
var Simulator=function(){var self,ctx,cav,size,slider,simTime,ctxColorBar,TAU=2*Math.PI,PI=Math.PI,projSource=new proj4.Proj("+proj=stere +lat_0=90 +lat_ts=70 +lon_0=-45 +k=1 +x_0=0 +y_0=0 +ellps=WGS84 +datum=WGS84 +units=m +no_defs"),projTarget=new proj4.Proj("EPSG:4326"),extend=4194304,display="part",doGears=false,doDeco=false,doCheck=5,doLatLon=false,hasData=false,isTouch="ontouchstart"in document.documentElement,variables={},variable="tmp2m",maxSpeed=0,fps=30,frames=0,doAnimate=false,animationFrame=
NaN,fpsBuffer=null,durBuffer=null,amount=750,border=50,particles=[],tracers=[],trash=[],maxSteps=30,timeFrame=0,minSpeed=1,uvFac=0.25,dampColor="rgba(255, 255, 255, 0.85)",Particle=function(x,y,step){this.x=this.x1=this.orgx=x;this.y=this.y1=this.orgy=y;this.step=step;this.speed=0;this.width=0;this.color="";this.tracer=false;this.mark=false;this.cache=H.range(maxSteps+1).map(function(){return{u:NaN,v:NaN}})},lastTime=0,charts={1:{id:1,chart:null,varis:["tmp2m","prmslmsl"],div:"sim-chart-1"},2:{id:2,
chart:null,varis:["apcpsfc","gustsfc"],div:"sim-chart-2"},3:{id:3,chart:null,varis:["dlwrfsfc","dswrfsfc"],div:"sim-chart-3"}},mouse={x:NaN,y:NaN,fx:384,fy:384,lat:NaN,lng:NaN,down:false},effects={interval:null,mouseWait:function(){var pi=Date.now()/200%TAU;ctx.strokeStyle="#FFFFFF";ctx.fillStyle="#FFFF00";ctx.lineWidth=4;ctx.beginPath();ctx.arc(mouse.fx,mouse.fy,12,pi-2,pi,true);ctx.stroke();ctx.beginPath();ctx.arc(mouse.fx,mouse.fy,3,0,TAU);ctx.fill()},chartLatLon:function(){ctx.strokeStyle="#FFFFFF";
ctx.fillStyle="#FF0000";ctx.lineWidth=3;ctx.beginPath();ctx.arc(mouse.fx,mouse.fy,10,0,TAU);ctx.stroke();ctx.beginPath();ctx.arc(mouse.fx,mouse.fy,3,0,TAU);ctx.fill()},mouseBlink:function(color){ctx.fillStyle=color||"white";ctx.beginPath();ctx.arc(mouse.fx,mouse.fy,12,0,TAU);ctx.fill()}},events={resize:function(){var winWidth=$(window).width(),cvsHeight=$("#simulator").height();self.drawColorBar(ctxColorBar);if(winWidth<992)$(".sim-chart").css({height:200});else $(".sim-chart").css({height:cvsHeight/
3})},onloadDods:function(errors,chartdatas){var lh=24;clearInterval(effects.interval);if(errors){effects.mouseBlink("red");doLatLon=false;ctx.fillStyle="white";if(errors.length)errors.forEach(function(line){ctx.fillText(line,12,lh);lh+=12});else ctx.fillText("ERROR with GFS",12,lh)}else{effects.mouseBlink();self.renderChart(chartdatas);setTimeout(function(){doLatLon=true},200)}},mouseup:function(){mouse.down=false;clearInterval(effects.interval);effects.interval=setInterval(effects.mouseWait,32);
self.hideCharts([1,2,3]);$(".sim-chart-info").html("retrieving forecast from GFS...");SIM.Model.getForecast(mouse.lat,mouse.lng,charts[1],events.onloadDods);SIM.Model.getForecast(mouse.lat,mouse.lng,charts[2],events.onloadDods);SIM.Model.getForecast(mouse.lat,mouse.lng,charts[3],events.onloadDods)},mousemove:function(e){var rect=cav.getBoundingClientRect();mouse.x=~~(e.clientX-rect.left);mouse.y=~~(e.clientY-rect.top)},mousedown:function(){var latlng,f=cav.width/parseInt($("#simulator").css("width"),
10);mouse.fx=mouse.x*f;mouse.fy=mouse.y*f;latlng=project(mouse.fx,mouse.fy);mouse.lat=latlng.y;mouse.lng=latlng.x;mouse.down=true;doLatLon=false},mouseScroll:function(e){step(e.originalEvent.detail<0?"right":"left");return false},mouseWheel:function(e){step(e.originalEvent.wheelDelta>0?"right":"left");return false},visibility:function(visible){if(visible)hasData&&self.animateStart();else self.animateStop()}},project=function(mouseX,mouseY){var x=scale(mouseX,0,cav.width,-extend,extend),y=scale(mouseY,
0,cav.height,extend,-extend);return proj4.transform(projSource,projTarget,{x:x,y:y})},unproject=function(lat,lng){var x,y,xy=proj4.transform(projTarget,projSource,{x:lng,y:lat});x=scale(xy.x,-extend,extend,0,cav.width);y=scale(xy.y,extend,-extend,0,cav.height);return{x:x,y:y}},clampScale=function(x,xMin,xMax,min,max){var val=(max-min)*(x-xMin)/(xMax-xMin)+min;return val<min?min:val>max?max:val},pad=function(s){return("00"+s).slice(-2)},step=function(where){slider.setValue(parseFloat(slider.getValue())+
(where==="right"?+0.25:-0.25),false,true)},scale=function(x,xMin,xMax,min,max){return(max-min)*(x-xMin)/(xMax-xMin)+min},rgbGrey=function(g){return"rgb("+g+","+g+","+g+")"},rgbGreyAlpha=function(g,alpha){return"rgba("+g+","+g+","+g+","+alpha+")"},colorTableAlpha=function(c,alpha){return c===0?"rgba(170, 102, 170, "+alpha+")":c===1?"rgba(206, 155, 229, "+alpha+")":c===2?"rgba(108, 206, 226, "+alpha+")":c===3?"rgba(108, 239, 108, "+alpha+")":c===4?"rgba(237, 249, 108, "+alpha+")":c===5?"rgba(251, 202,  98, "+
alpha+")":c===6?"rgba(251, 101,  78, "+alpha+")":c===7?"rgba(204,  64,  64, "+alpha+")":"black"},colorTableHex={"0":"#aa66aa",1:"#ce9be5",2:"#76cee2",3:"#6cef6c",4:"#edf96c",5:"#ffbb55",6:"#fb654e",7:"#cc4040"},colorTableDegree={"0":"-40\u00b0C",1:"-30\u00b0C",2:"-20\u00b0C",3:"-10\u00b0C",4:"  0\u00b0C",5:"+10\u00b0C",6:"+20\u00b0C",7:"+30\u00b0C"};return{boot:function(){return self=this},utcDatetime:function(){var time=parseFloat(slider.getValue());return(new Date(Date.UTC(1970,0,~~time+1,24*(time%
1)))).toUTCString()},conv:function(para){var d;if(para.length===10){d=para.split("-");return new Date(Date.UTC(d[0],d[1]-1,d[2]))}else return[para.getUTCFullYear(),pad(para.getUTCMonth()+1),pad(para.getUTCDate())].join("-")},makeDayRange:function(iso1,iso2){var d1=self.conv(iso1),d2=self.conv(iso2),range=[];while(d1<=d2){range.push(self.conv(d1));d1.setUTCDate(d1.getUTCDate()+1)}return range},makeFilenameDate:function(d){return[d.getUTCFullYear(),H.padZero(d.getUTCMonth()+1),H.padZero(d.getUTCDate()),
H.padZero(d.getUTCHours())].join("-")+"H"},createFilename:function(type){var time=parseFloat(slider.getValue()),datetime=new Date(Date.UTC(1970,0,~~time+1,24*(time%1)));return"weathersim-"+self.makeFilenameDate(datetime)+"."+type},screenshot:function(){var canvas,oldDeco=doDeco;doDeco=false;self.animateStart();canvas=self.compose(cav,32+512+20);canvas.toBlob(function(blob){saveAs(blob,self.createFilename("png"))},"image/png");doDeco=oldDeco;return false},videoshot:function(){var img,imgData,blob,
framesVideo=30,size=512,images=[],oldCheck=doCheck,oldAmount=amount;function finish(obj){self.animateStart();$("#simulation-header .fa-spinner").addClass("fa-film").removeClass("fa-spin").removeClass("fa-spinner");if(!obj.error){blob=H.base64toBlob(obj.image.slice(22),"image/gif");saveAs(blob,self.createFilename("gif"))}doCheck=oldCheck;self.updateAmount(oldAmount)}$("#simulation-header .fa-film").addClass("fa-spinner").addClass("fa-spin").removeClass("fa-film");doDeco=false;doLatLon=false;self.updateAmount(1250);
setTimeout(function(){self.animateRecord(framesVideo,function(frame,canvas){canvas=self.compose(cav,size);img=new Image;img.src=canvas.toDataURL();images.push(img);if(frame===framesVideo)gifshot.createGIF({gifWidth:size,gifHeight:size+52,interval:0.066666/2,numFrames:framesVideo,images:images},finish)})},1200);return false},compose:function(canvas,size){size=size||512;var top=32,btm=20,height=top+size+btm,logo=top-8,brd=16,cvs=$("#sim-compositor")[0],ctx=cvs.getContext("2d"),bck=$("#sim-background")[0],
log=$(".navbar-brand img")[0];cvs.width=size;cvs.height=height;ctx.fillStyle="#2c3b47";ctx.fillRect(0,0,cvs.width,cvs.height);ctx.drawImage(bck,0,top,size,size);ctx.drawImage(canvas,0,top,size,size);ctx.fillStyle="white";ctx.textAlign="left";ctx.font="20px sans-serif";ctx.fillText("arctic.io".split("").join(String.fromCharCode(8202)),logo+brd+brd/2,22);ctx.drawImage(log,brd,(top-logo)/2,logo,logo);ctx.textAlign="right";ctx.font="18px monospace";ctx.fillText("GFS Weather Simulation",size-brd,22);ctx.fillStyle=
"rgba(0, 0, 0, 0.3)";ctx.fillRect(0,top,size,14+6);ctx.textAlign="right";ctx.font="bold 14px monospace";ctx.fillStyle="white";ctx.fillText(self.utcDatetime().replace(":00:00",":00"),size-brd,top+14+2);ctx.textAlign="left";ctx.font="14px monospace";ctx.fillText("2m temp. 10m wind",brd,top+14+2);ctx.textAlign="left";self.drawColorBar(ctx,top+size,btm);return cvs},drawColorBar:function(ctx,top,height){top=top||0;height=height||20;var x,w8=ctx.canvas.width/8,fontsize=height-6;for(x=0;x<8;x++){ctx.fillStyle=
colorTableHex[x];ctx.fillRect(x*w8,top,w8,height);ctx.font=fontsize+"px monospace";ctx.fillStyle="black";ctx.fillText(colorTableDegree[x],x*w8+2,top+fontsize+2)}},prepSlider:function(marray){var max=Math.max.apply(Math,Object.keys(marray.data))+3*0.25,min=Math.min.apply(Math,Object.keys(marray.data)),now=roundUp(H.date2doeFloat(Date.now()));function fmt(time){var dd=new Date(Date.UTC(1970,0,~~time+1,24*(time%1)));return[dd.getUTCFullYear(),pad(dd.getUTCMonth()+1),pad(dd.getUTCDate())].join("-")}function roundUp(num){return num+
(0.25-num%0.25)}if(slider){$("#simulation .slider.slider-horizontal").unbind("DOMMouseScroll",events.mouseScroll);$("#simulation .slider.slider-horizontal").unbind("mousewheel",events.mouseWheel);slider.destroy()}slider=new Slider("#sim-slider",{step:0.25,value:now>min&&now<max?now:min,ticks:[min,max],tooltip:"hide"});$("#sim-time-label-l").text(fmt(min));$("#sim-time-label-r").text(fmt(max));$("#simulation .slider.slider-horizontal").bind("DOMMouseScroll",events.mouseScroll);$("#simulation .slider.slider-horizontal").bind("mousewheel",
events.mouseWheel);slider.on("change",self.updateTime)},prependRange:function(diff){var datum2=dataTimeRanges["gfs-simulation"][0][1],d=datum2.split("-"),d1=new Date(Date.UTC(d[0],d[1]-1,d[2]-diff)),datum1=[d1.getUTCFullYear(),pad(d1.getUTCMonth()+1),pad(d1.getUTCDate())].join("-");dataTimeRanges["gfs-simulation"].unshift([datum1,datum2])},selectedRange:function(){var key=$("#sim-ranges").find("option:selected").val().split(" - ");return dataTimeRanges["gfs-simulation"][key]},onload:function(canvas){var range;
cav=$(canvas)[0];ctx=cav.getContext("2d");size=cav.width;ctxColorBar=$("#sim-colorbar")[0].getContext("2d");simTime=$("#sim-time-label-m");cav.addEventListener("mousemove",events.mousemove,false);cav.addEventListener("mousedown",events.mousedown,false);cav.addEventListener("mouseup",events.mouseup,false);Sections.on("simulation",events.visibility);fpsBuffer=H.createRingBuffer(60);durBuffer=H.createRingBuffer(60);self.prependRange(14);range=dataTimeRanges["gfs-simulation"][0];$.each(dataTimeRanges["gfs-simulation"],
function(key,value){$("#sim-ranges").append($("<option/>",{value:key,text:value[0]+" - "+value[1]}))});$("#sim-ranges").on("change",function(){self.loadRange(self.finishLoad)}).selectpicker("refresh");$(window).on("resize",events.resize);events.resize();$("#sim-fps").val(fps);$("#sim-gears").css({display:doGears?"block":"none"});TIM.step("LOADING","SIM: "+JSON.stringify(dataTimeRanges["gfs-simulation"][0]));setTimeout(function(){self.loadRange(self.finishLoad)},200);SIM.Model.sync(function(run){effects.mouseWait();
$(".sim-chart-info").html(H.format("retrieving data from GFS (%s) ...",run));SIM.Model.getForecast(90,0,charts[1],events.onloadDods);SIM.Model.getForecast(90,0,charts[2],events.onloadDods);SIM.Model.getForecast(90,0,charts[3],events.onloadDods)})},loadRange:function(callback){function progessBlob(e){currLoad+=e.diff;ctx.fillStyle="rgba(255, 255, 255, 1)";ctx.fillRect(0,0,cav.width/fullLoad*currLoad,24);ctx.fillStyle="black";ctx.font="16px sans serif";ctx.fillText("GFS 2m Temp, 10m Wind: "+~~(100/
fullLoad*currLoad)+"%",4,16)}function progessImage(e){currImage=e;ctx.fillStyle="rgba(255, 255, 255, 1)";ctx.fillRect(0,0,cav.width/fullImage*currImage,24);ctx.fillStyle="black";ctx.font="16px sans serif";ctx.fillText("AMSR2 Sea Ice Concentration: "+~~(100/fullImage*currImage)+"%",4,16)}function iso2file(iso){return iso.split("-")[0]+"/"+iso+".sim"}var dateRange=self.selectedRange(),dates=self.makeDayRange(dateRange[0],dateRange[1]),currLoad=0,currImage=0,fullImage=dates.length,fullLoad=dates.length*
101540,tasks=dates.map(iso2file).map(function(file){return function(callback){var blobs=new SIM.Blobs(file,progessBlob,function(){callback(null,blobs)})}});variables={};doAnimate=false;ctx.clearRect(0,0,cav.width,cav.height);SIM.Blender.loadRange(dates,progessImage,function(){ctx.clearRect(0,0,cav.width,cav.height);async.parallel(tasks,callback)})},finishLoad:function(err,results){var marray,doe,t0=Date.now(),bytes=0,days=0;if(err)console.error(err);else;results.forEach(function(res){if(!Object.keys(variables).length)Object.keys(res.vars).forEach(function(vari){marray=
new SIM.MArray;marray.grid=res.vars[vari].grid;variables[vari]=marray});Object.keys(res.vars).forEach(function(vari){doe=~~(res.Day/864E5);variables[vari].data[doe]=res.vars[vari].data;variables[vari].data[doe].shape=res.vars[vari].shape;variables[vari].analyzeDoe(doe)})});ctx.clearRect(0,0,cav.width,cav.height);Object.keys(variables).forEach(function(vari){bytes+=variables[vari].bytes();days=results.length});TIM.step("LOADED",[((Date.now()-t0)/1E3).toFixed(2),"secs",bytes,"bytes",days,"days"].join(" "));
self.prepSlider(variables.ugrd10m);self.updateTime();self.updateFps();self.updateAmount(amount);self.toggleDisplay("part");hasData=true;if(Sections.isVisible("simulation"))setTimeout(self.animateStart,500)},animateRecord:function(length,callback){var fps=30;self.animateStop();self.animateStart(fps,function(frame,cvs){if(frame>length)self.animateStop();else callback(frame,cvs)})},animateToggle:function(){if(doAnimate)self.animateStop();else self.animateStart()},animateStop:function(){doAnimate=false;
cancelAnimationFrame(animationFrame);$("#sim-btn-toggle").text("Run")},animateStart:function(requestedFps,callback){requestedFps=requestedFps||fps;var t0=0,now=0,elapsed,interval=1E3/requestedFps,then=Date.now(),last=then;frames=0;doAnimate=true;cancelAnimationFrame(animationFrame);$("#sim-btn-toggle").text("Stop");self.updateParticles();animate();function animate(){if(!doAnimate)return;animationFrame=requestAnimationFrame(animate);now=Date.now();elapsed=now-then;if(elapsed>interval){t0=Date.now();
then=now-elapsed%interval;fpsBuffer.push(1E3/(t0-last));last=t0;frames+=1;timeFrame+=1;self.updateParticles();self.render();doDeco&&self.decorate(t0);doLatLon&&effects.chartLatLon();callback&&callback(frames,cav);doCheck&&frames%120===0&&self.adjustFps();durBuffer.push(Date.now()-t0)}}},adjustFps:function(){var dur=durBuffer.avg(),max=1E3/fps*0.6;if(dur>max){fps=fps>10?fps-10:5;doCheck=fps>10?doCheck-1:0;$("#sim-fps").val(fps);self.animateStart();TIM.step("ADJUSTED",["FPS","dur:",dur.toFixed(1),"max",
max.toFixed(1),"fps",fps,"frame",frames,"avg",fpsBuffer.avg().toFixed(1)].join(" "))}},render:function render(){var i,p,len=particles.length;ctx.globalCompositeOperation="destination-in";ctx.fillStyle=dampColor;ctx.fillRect(0,0,size,size);ctx.globalCompositeOperation="source-over";ctx.lineCap="round";SIM.Blender.blend(ctx,0.3);for(i=0;i<len;i++){p=particles[i];p.step+=1;self.check(p);self.forward(p);self.update(p);ctx.beginPath();ctx.strokeStyle=p.color;ctx.lineWidth=p.width;ctx.moveTo(p.x,p.y);ctx.lineTo(p.x1,
p.y1);ctx.stroke();p.x=p.x1;p.y=p.y1}len=tracers.length;for(i=0;i<len;i++){p=tracers[i];self.forward(p);self.check(p);ctx.beginPath();ctx.strokeStyle="white";ctx.lineWidth=3;ctx.moveTo(p.x,p.y);ctx.lineTo(p.x1,p.y1);ctx.stroke();p.x=p.x1;p.y=p.y1}len=trash.length;for(i=0;i<len;i++)self.deleteParticle(tracers,function(part){return part===trash[i]});if(trash.length)trash.splice(0,trash.length)},renderData:function(){var x,y,value,grey,color,marray=variables[variable],cube=marray.first(),shape=cube.shape,
xy=shape[1]-1,wh=size/xy,min=marray.min,max=marray.max;ctx.clearRect(0,0,cav.width,cav.height);for(x=0;x<xy;x++)for(y=0;y<xy;y++){value=marray.getXY(x,y);if(variable==="icec")if(value===-128)ctx.fillStyle="rgba(0,0,0,0)";else{grey=scale(value,-128,+127,128,255);ctx.fillStyle=rgbGrey(~~grey)}else if(variable==="tmp2m"){color=~~clampScale(value,-40,+30,0,7);ctx.fillStyle=colorTableAlpha(color,0.6)}else{grey=scale(value,min,max,0,255);ctx.fillStyle=rgbGreyAlpha(~~grey,0.6)}ctx.fillRect(x*wh,y*wh,wh,
wh)}SIM.Blender.blend(ctx,0.7)},hideCharts:function(list){var chart;list.forEach(function(id){if(chart=charts[id].chart){chart.options.data.forEach(function(datatset){datatset.color="transparent";datatset.lineColor="transparent"});chart.render()}})},renderChart:function(chartdatas){var chart,chartinfo=chartdatas[0][0],id=chartinfo.id,primVari=chartdatas[0][0].varis[0],secVari=chartdatas[1][0].varis[1],datagramms=chartdatas.map(function(datas){return datas[1]}),ref=datagramms[0],lng=ref.lng+(ref.lng>
0?"\u00b0E":"\u00b0W"),dateFormatter=function(d){return[d.getUTCFullYear(),H.padZero(d.getUTCMonth()+1),H.padZero(d.getUTCDate())].join("-")+"&nbsp;"+H.padZero(d.getUTCHours())+"h"+"&nbsp;UTC"},numberFormatter=function(num){return parseFloat(num).toFixed(1)},config={animationEnabled:true,animationDuration:1E3,exportFileName:H.format("GFS-Forecast %s, %s",ref.lat+"\u00b0N",lng),exportEnabled:true,backgroundColor:"#4D4D4D",colorSet:"nomads",toolTip:{shared:false,contentFormatter:function(e){var i,vari,
content=" ",letter,metric;for(i=0;i<e.entries.length;i++){vari=e.entries[i].dataSeries.name;metric=SIM.Vars[vari].unit;letter=SIM.Vars[vari].letter;content+=dateFormatter(e.entries[i].dataPoint.x)+"<br />";content+=letter+": "+numberFormatter(e.entries[i].dataPoint.y)+"&nbsp;"+metric+"<br />"}return content}},legend:{fontSize:12,fontColor:"#EEE",cursor:"pointer",itemclick:function(e){console.log("CLICK",e)},dockInsidePlotArea:false,horizontalAlign:"center",verticalAlign:"top"},axisX:{lineThickness:2,
labelFontSize:11,labelFontColor:"#EEE",valueFormatString:"UTC:YY-MM-DD",gridThickness:0.25,minimum:ref.minDate,interval:24,intervalType:"hour"},axisY:{labelFontSize:11,labelFontColor:"#EEE",gridThickness:0.5},axisY2:{labelFontSize:11,labelFontColor:"#EEE",minimum:SIM.Vars[secVari].range[0],maximum:SIM.Vars[secVari].range.slice(-1)[0]},data:[]};if(SIM.Vars[primVari].range){config.axisY.minimum=SIM.Vars[primVari].range[0];config.axisY.maximum=SIM.Vars[primVari].range.slice(-1)[0];if(SIM.Vars[primVari].range.length>
2);}datagramms.forEach(function(datagramm){var vari=datagramm.vari,series={dataPoints:[],type:"line",name:vari,visible:true,connectNullData:false,vari:vari,showInLegend:true,color:SIM.Vars[vari].color,LineColor:SIM.Vars[vari].color,axisYType:SIM.Vars[vari].axis,legendText:SIM.Vars[vari].legend,markerType:"circle",markerSize:1,lineThickness:3,xValueFormatString:"UTC:YYYY-MM-DD HH K",mouseover:function(){},mousemove:function(){},mouseout:function(){}};H.zip(datagramm.stamps,datagramm.datas,function(stamp,
datapoint){series.dataPoints.push({x:stamp,y:isNaN(datapoint)?null:datapoint})});config.data.push(series)});$(".sim-chart-info").html(H.format("Forecast: %s, %s",ref.lat+"\u00b0N",lng));$("#"+chartinfo.div).css({display:"block"});chart=charts[id].chart=new CanvasJS.Chart(chartinfo.div,config);chart.render();$(".canvasjs-chart-container button img").attr("src","/images/simulator/chart-button.png")},decorate:function(t1){var w=cav.width,f=cav.width/parseInt($("#simulator").css("width"),10),mx=~~(mouse.x*
f),my=~~(mouse.y*f),sys="",t="t2m: "+variables.tmp2m.interpolateXY(mx,my).toFixed(1)+"\u00b0C",u=variables.ugrd10m.interpolateXY(mx,my),v=variables.vgrd10m.interpolateXY(mx,my),s="speed: "+Math.sqrt(u*u+v*v).toFixed(1)+" m/s, ",ms=maxSpeed.toFixed(1)+" m/s max wind",info="mouse: "+mouse.x+", "+mouse.y+", "+t+", "+s+ms;sys=frames+" / "+("00"+(Date.now()-t1)).slice(-2)+"ms, ";sys+="fps: "+fpsBuffer.avg().toFixed(1)+", ";sys+="particles: "+particles.length+", ";sys+="tracers: "+tracers.length+", ";ctx.fillStyle=
"rgba(0, 0, 0, 0.3)";ctx.fillRect(0,0,w,36);ctx.fillStyle="white";ctx.font="16px monospace";ctx.fillText(sys,4,16);ctx.fillText(info,4,32)},deleteParticle:function(a,fn){var i=0,o=0;while(a[i]!==undefined)if(fn(a[i])){a.splice(i,1);o++}else i++;return o},updateParticles:function(){var i,p,len=particles.length;if(amount===len)return;else if(amount>len){for(i=len;i<amount;i++){p=new Particle(Math.random()*(size+border+border)-border,Math.random()*(size+border+border)-border,~~(Math.random()*(maxSteps+
0.5)));particles.push(p);self.forward(p)}TIM.step("CREATED",amount-len+" particles")}else{particles.splice(amount,particles.length-amount);TIM.step("DROPPED",amount-len+" particles")}},check:function(p){if(p.tracer&&(p.x<0||p.x>size||p.y<0||p.y>size||p.speed<minSpeed))trash.push(p);if(!p.tracer&&p.step>=maxSteps){p.x=p.orgx;p.y=p.orgy;p.step=0;p.s=0;p.color=""}},forward:function(p){var x,y,u,v,step=p.step;if(timeFrame>=maxSteps){u=p.cache[step].u;v=p.cache[step].v}else{x=p.x<0?0:p.x>size?size:p.x,
y=p.y<0?0:p.y>size?size:p.y,u=variables.ugrd10m.interpolateXY(x,y),v=variables.vgrd10m.interpolateXY(x,y);p.cache[step].u=u;p.cache[step].v=v}p.speed=Math.sqrt(u*u+v*v);p.x1=p.x+u*uvFac;p.y1=p.y-v*uvFac;maxSpeed=p.speed>maxSpeed?p.speed:maxSpeed},forwardX:function(p){var x=p.x<0?0:p.x>size?size:p.x,y=p.y<0?0:p.y>size?size:p.y,u=variables.ugrd10m.interpolateXY(x,y),v=variables.vgrd10m.interpolateXY(x,y);p.speed=Math.sqrt(u*u+v*v);p.x1=p.x+u*uvFac;p.y1=p.y-v*uvFac;maxSpeed=p.speed>maxSpeed?p.speed:
maxSpeed},update:function(p){var x,y,color,t2m,speed=p.speed;if(!p.color){x=p.x<0?0:p.x>size?size:p.x;y=p.y<0?0:p.y>size?size:p.y;t2m=variables.tmp2m.interpolateXY(x,y);color=~~clampScale(t2m,-40,+30,0,7);p.color=colorTableHex[color]}p.width=speed<2.5?2:speed<5?2.5:speed<10?3:speed<20?3.5:4},toggleDisplay:function(what,vari){vari=vari||"tmp2m";ctx.clearRect(0,0,cav.width,cav.height);$('input[value="'+what+'"]').prop("checked",true);if(what==="part"){self.animateStart();$("#sim-field-data").prop("disabled",
true)}else if(what==="data"){self.animateStop();variable="tmp2m";$("#sim-field-data").prop("disabled",false);$('input[value="'+vari+'"]').prop("checked",true);self.renderData()}display=what},toggleData:function(vari){display!=="data"&&Simulator.toggleDisplay("data",vari);variable=vari;self.renderData()},toggleGears:function(){doGears=doDeco=!doGears;$("#sim-gears").css({display:doGears?"block":"none"})},toggleInfo:function(){var classShowInfoGui="col-xs-offset-1 col-xs-10 col-sm-offset-1 col-sm-10 col-md-offset-0 col-md-8 col-lg-offset-0 col-lg-7 sim-gui",
classHideInfoGui="col-xs-offset-1 col-xs-10 col-sm-offset-1 col-sm-10 col-md-offset-2 col-md-8 col-lg-offset-2 col-lg-7 sim-gui";if($("#simulation .sim-info").css("display")==="none")$("#simulation .sim-info").css({display:"block"});else $("#simulation .sim-info").css({display:"none"})},updateFps:function(){fps=~~$("#sim-fps").val();maxSpeed=fps;uvFac=0.25/(fps/30);self.animateStart();TIM.step("UPDATED-FPS",["fps:",fps,"avg",fpsBuffer.avg().toFixed(1)].join(" "))},updateAmount:function(newAmount){if(newAmount)$("#sim-amount").val(newAmount);
amount=~~$("#sim-amount").val();timeFrame=0},updateTime:function(){var datetime,time=parseFloat(slider.getValue());if(time&&time!==lastTime){timeFrame=0;datetime=new Date(Date.UTC(1970,0,~~time+1,24*(time%1)));$("#sim-time-label-m").text(datetime.toUTCString().replace(":00:00",":00"));Object.keys(variables).forEach(function(name){variables[name].setDateSize(datetime,size)});SIM.Blender.setDateSize(datetime,size);display==="data"&&self.renderData();lastTime=time}}}}().boot();
