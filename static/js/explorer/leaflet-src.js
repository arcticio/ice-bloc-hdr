...
L.Map = L.Class.extend({
	...
	options: {
		...
		*/
		...
		fadeAnimation: false, // L.DomUtil.TRANSITION && !L.Browser.android23,
		trackResize: true,
...
L.ImageOverlay = L.Class.extend({
	...
	_animateZoom: function (e) {
		var map = this._map,
		    ...
		    nw = new L.LatLng(this._mybounds[0][0], this._mybounds[0][1]),
		    se = new L.LatLng(this._mybounds[1][0], this._mybounds[1][1])
	...
	_reset: function () {
		var image   = this._image,
		    ...
		    topLeft = this._map.latLngToLayerPoint(new L.LatLng(this._mybounds[0][0], this._mybounds[0][1])),
		    downRight = this._map.latLngToLayerPoint(new L.LatLng(this._mybounds[1][0], this._mybounds[1][1])),
		    // size = this._map.latLngToLayerPoint(this._bounds.getSouthEast())._subtract(topLeft);
		    size = this._map.latLngToLayerPoint(new L.LatLng(this._mybounds[1][0], this._mybounds[1][1]))._subtract(topLeft);

		L.DomUtil.setPosition(image, topLeft);

		// console.log("NW, tl, dr, w, h", topLeft, downRight, size.x, size.y);
